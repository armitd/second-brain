...
status: "planning"
created: "2026-05-18"
tags: ["#project", "#personal", "#party", "#birthday"]
---
...
A weekend-long outdoor birthday celebration in a Somerset field. Two nights, proper Somerset countryside, space to gather people for the whole weekend rather than just an evening.

---

## Key Numbers

- **77 confirmed** across 45 parties · **31 uncertain** across 14 parties
- **Maximum: 108 people** if all uncertainties confirm
- **Planning number: ~90–100**
- Children: at least 2 confirmed (Jim + Carly's kids); up to 5 more if Work group confirms
- Full guest list: [[GUEST-LIST|Guest List →]]

## Still to Confirm

- [ ] Overnight guests vs day visitors (Saturday only?)
- [ ] Field owner / access arrangements confirmed
...
### Venue & Field
- [ ] Confirm field access dates — arrive Thursday 6th to set up? 📅 2026-05-25
- [ ] Check field size and layout — identify flat areas for tents/structures 📅 2026-05-25
- [ ] Confirm gate/track vehicle access for deliveries and trailers 📅 2026-05-25
- [ ] Establish a site map (parking, camping zone, main area, loos) 📅 2026-06-01
- [ ] Check if there's a water supply on site 📅 2026-05-25
- [ ] Check if there's any electricity supply on site 📅 2026-05-25

### Accommodation & Camping
- [ ] Decide: camping only, or mix of camping + glamping options?
- [ ] Decide: provide any tents/gazebos, or BYO?
- [ ] Identify nearby B&B / pub accommodation for guests who won't camp 📅 2026-06-01
- [ ] Consider hiring bell tents or a large gathering tent/marquee
- [ ] Communicate accommodation options to guests when inviting
...
- [ ] **Tables & chairs:** Hire or borrow — estimate based on guest count 📅 2026-06-15
- [ ] **Water:** If no supply, arrange water carriers / barrels for washing up
...
- [ ] Westbury-sub-Mendip is near Cheddar Gorge and Ebbor Gorge — walks worth planning
- [ ] Games: croquet, boules, giant Jenga, volleyball net?
...
- [ ] **Temporary Event Notice (TEN):** Required for events with 500+ people or selling alcohol — apply via local council at least 10 working days before event 📅 2026-07-15
- [ ] **Public liability insurance:** Get a one-off event policy — typically £50-150 for a private event 📅 2026-07-01
...
### Logistics & Setup
- [ ] Arrange transport for kit to site (trailer? hire van?) 📅 2026-07-15
- [ ] Plan setup crew — who's arriving Thursday to help set up?
- [ ] Plan breakdown crew — who's staying Sunday to help clear up?
...
**Friday 7 August — Arrival**
- Guests arrive from midday / afternoon
- Welcome drinks, relaxed setup, early evening meal
- Fire pit / informal evening

**Saturday 8 August — The Main Event**
- Daytime: activities, walks, hanging out
- Afternoon: set up for evening
- Evening: main celebration — food, music, speeches, dancing, bonfire
- Late night: carry on as long as the energy lasts

**Sunday 9 August — Morning After**
...
|----------|-----------|--------|
| Venue / field | TBC | - |
| Portable toilets | £300–600 | - |
| Generator hire | £150–300 | - |
| Marquee / large shelter | £400–800 | - |
| Tables & chairs hire | £200–400 | - |
| Lighting | £100–200 | - |
| Food (all meals) | TBC | - |
| Drinks | TBC | - |
| Entertainment / music | TBC | - |
| Public liability insurance | £50–150 | - |
| Invitations / printing | £50–100 | - |
| Miscellaneous | £200 | - |
| **Total estimated** | **TBC** | - |
...
*Add decisions here as they're made — helps avoid revisiting the same questions.*

---

*Personal project. Created 18 May 2026.*
