...
distance_km: 25
tags: ["#project", "#personal", "#walking", "#jurassic-coast"]
---

# Jurassic Coast Walk — 28 May 2026
...
- [ ] Final weather check
- [ ] Download offline maps to phone (in case of no signal)
- [ ] Set alarm — allow time for travel to start point
- [ ] Tell someone the route plan and expected return time
- [ ] Fill water bottles

### Walk Day (28 May)

- [ ] Start time: TBC (aim for early to avoid crowds and heat)
- [ ] Route confirmed, GPX loaded
- [ ] Return transport arranged (X53 or second car)
...
- [ ] Merino or walking socks × 2 pairs
- [ ] Liner socks (if prone to blisters)
- [ ] Walking trousers / shorts (not jeans)
- [ ] Moisture-wicking base layer
- [ ] Fleece or mid layer
- [ ] Waterproof jacket (taped seams)
- [ ] Waterproof overtrousers
- [ ] Warm hat + gloves (sea fret can be cold even in May)
- [ ] Sun hat + sunglasses

### Navigation & Electronics
- [ ] Phone with OS Maps / Komoot — offline map downloaded ✓
- [ ] Paper OS map backup (OL116 Lyme Regis & Bridport, or OL15 Purbeck)
- [ ] Portable charger / power bank — fully charged
- [ ] GPS watch or running watch (optional but useful for distance tracking)
...
### Food & Water
- [ ] Water — 2L minimum (fill before you leave; limited sources on the coast path)
- [ ] Packed lunch
- [ ] Snacks: energy bars, nuts, flapjack, fruit
- [ ] Flask of tea/coffee (optional but very welcome at a viewpoint)
- [ ] Emergency snack (extra bar or gel in case of a longer day than planned)

### First Aid & Safety
- [ ] Blister kit — **Compeed is non-negotiable on a 25km day**
- [ ] Paracetamol / ibuprofen
- [ ] Ankle bandage
- [ ] Sunscreen SPF30+
- [ ] Lip balm
- [ ] Insect repellent (grass ticks on clifftops in May/June)
...
*Personal project. Created 2026-05-19. Walk date: 2026-05-28.*
