# If you’re not using Claude Cowork yet this article is...

![rw-book-cover](https://pbs.twimg.com/profile_images/2012162102283407360/U-fPj6wg.jpg)

## Metadata
- Author: [[0xMarioNawfal]]
- Full Title: If you’re not using Claude Cowork yet this article is...
- Category: #tweets
- Summary: If you’re not using Claude Cowork yet this article is for you
- URL: https://twitter.com/RoundtableSpace/status/2034975284752261479/?rw_tt_thread=True

## Full Document
If you’re not using Claude Cowork yet this article is for you

[x.com/jspujji/status…](https://x.com/jspujji/status/2034616093386678778?s=46) 

![](https://pbs.twimg.com/profile_images/1490919560517722113/DgMhDobG.jpg)

[Jesse Pujji](https://twitter.com/jspujji)
[@jspujji](https://twitter.com/jspujji)

![How to Use Claude Cowork Like a Second Employee](https://pbs.twimg.com/media/HDtwAwBawAADHI0.jpg)
...
Download Claude Desktop from [claude.com/download](http://claude.com/download) (Cowork can’t be downloaded through the browser). 
...
**[who-i-am.md](http://who-i-am.md/)** → Literally answers who I am, a brief intro, what I do, my current priorities, where I spend time, and also where I don’t spend time (just as helpful). 

**[how-i-talk.md](http://how-i-talk.md/)** → When Cowork is creating writing for me, it’s all based on this: how I communicate, samples of my writing. I’ve used multiple Granola recordings to train this to my speaking voice. 

**[how-you-work.md](http://how-you-work.md/)** → How Cowork should work for you. EX: “Don’t delete without confirming. Ask questions in a concise, bullet point format. Output format should be .pdf.” 
...
1. Download pre-built skills from sites like Notion, Figma, and Atlassian
2. Create your own skills with Claude Chat
...
```
Organize all files in /client-a/raw into subfolders by type: briefs, assets,  
reports, creative, and notes. Rename all files using the format YYYY-MM-  
DD-descriptive-name. Create a summary log documenting every change.   
Don't delete anything. If a file could belong to multiple categories, put it   
in /needs-review.  
...
```
Research micro-influencers (5K-50K followers) in the [niche] space on   
Instagram and TikTok. I'm looking for creators who post [content style]   
and whose audience matches this ICP: [description]. Build a spreadsheet   
with: handle, platform, follower count, avg engagement rate, content   
style notes, and any contact info you can find. Save to /client-  
b/influencer-sourcing/.  
...
updates, pricing changes, or positioning shifts from the past 7 days.   
Check [industry publications] for relevant coverage. Save a summary brief   
to /competitive-intel/[YYYY-MM-DD-weekly-brief.md](http://YYYY-MM-DD-weekly-brief.md). Flag anything that   
...
[Posted Mar 19, 2026 at 1:00PM](https://twitter.com/jspujji/status/2034616093386678778)
