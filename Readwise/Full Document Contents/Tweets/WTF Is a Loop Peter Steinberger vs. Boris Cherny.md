...
![rw-book-cover](https://pbs.twimg.com/profile_images/1565403341647400960/55RW_HGX.jpg)

## Metadata
- Author: [[Matt Van Horn]]
- Full Title: WTF Is a Loop? Peter Steinberger vs. Boris Cherny
- Category: #tweets
- Summary: A loop is a small program that prompts an AI agent, checks its work, and repeats until done. The real challenge is making loops reliable and stopping them from running forever. Loops are now the costly part of AI coding, not writing the code itself.
- URL: https://x.com/mvanhorn/status/2063865685558903149/?s=12&rw_tt_thread=True

## Full Document
![WTF Is a Loop? Peter Steinberger vs. Boris Cherny](https://pbs.twimg.com/media/HKRJqM9acAALukQ.jpg)
