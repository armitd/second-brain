# Me at 3 am realizing I've been suffering for years…...

![rw-book-cover](https://pbs.twimg.com/profile_images/1980701615863554048/JOVFMTE2.jpg)

## Metadata
- Author: [[Defileo🔮]]
- Full Title: Me at 3 am realizing I've been suffering for years…...
- Category: #tweets
- Summary: Me at 3 am realizing I've been suffering for years… and it took just 1 fvckin free article.
- URL: https://twitter.com/defileo/status/2042464905643819237/?rw_tt_thread=True

## Full Document
Me at 3 am realizing I've been suffering for years… and it took just 1 fvckin free article. 

Your browser does not support the video tag.

![](https://pbs.twimg.com/profile_images/1980701615863554048/JOVFMTE2.jpg)

[Defileo🔮](https://twitter.com/defileo)
[@defileo](https://twitter.com/defileo)

![Claude + Obsidian have to be illegal](https://pbs.twimg.com/media/HFdNOp3WUAAFflr.jpg)## **Claude + Obsidian should be illegal.** 
...
Your browser does not support the video tag.#### Here's exactly how it works, and how you can build it yourself this week, it will take you few hours to save you THOUSANDS of hours:
...
**Y**ou don't even need to open Obsidian, point Claude Code at the folder, work from the terminal, and your second brain quietly builds itself in the background. 
...
update [index.md](http://index.md) with a link and one-line description, and update any   
...
in /raw-sources/. Write a health report to /wiki/[lint-report.md](http://lint-report.md) with   
...
```
claude -p "Write a Python script called [morning\_digest.py](http://morning_digest.py) that:  
1) reads [Memory.md](http://Memory.md) and surfaces any open actions due today  
...
```
claude -p "Read the transcript in /transcripts/[call-today.md](http://call-today.md).  
Extract every decision made, every action item with owner and deadline,  
and a 3-bullet summary. Add actions to /[Action-Tracker.md](http://Action-Tracker.md), log decisions   
to /[Decision-Log.md](http://Decision-Log.md), and create a client note in /clients/ linking back   
...
[Posted Apr 9, 2026 at 1:59PM](https://twitter.com/defileo/status/2042241063612502162)
