...
## Metadata
- Author: [[CyrilXBT]]
- Full Title: How to Build an Obsidian Knowledge Vault That Gets Smarter Every Day Without You Doing Anything 
- Category: #tweets
- Summary: This guide shows how to build an Obsidian vault that automatically collects and connects your information using Claude and other tools. The vault organizes your notes into five folders and uses daily and weekly briefings to surface new insights without extra effort. Over time, the system becomes a smart thinking partner that helps you remember and discover ideas you might forget.
- URL: https://twitter.com/cyrilXBT/status/2052235121416188114/?rw_tt_thread=True

## Full Document
![How to Build an Obsidian Knowledge Vault That Gets Smarter Every Day Without You Doing Anything ](https://pbs.twimg.com/media/HHrj5tuXUAAJoUQ.jpg)
...
Node 1: Telegram Trigger → event: message → chat\_id: your\_bot\_id 

Node 2: Code (format note) → filename: inbox/{{date}}-[quick-capture.md](http://quick-capture.md) → content: # Quick Capture / {{message}} / Source: Telegram / Date: {{date}} 
...
[CLAUDE.md](http://CLAUDE.md) — The instruction layer. The file Claude reads first in every session. Tells it who you are, what you are working on, and what you want from it. 
...
STEP THREE: THE [CLAUDE.md](http://CLAUDE.md) FILE THAT MAKES EVERYTHING WORK 
...
[CLAUDE.md](http://CLAUDE.md) is a markdown file in the root of your vault. Claude reads it automatically at the start of every session. Copy this template directly: 
...
Update the Current Projects and What I Am Reading sections every Monday morning. Five minutes. This single habit is what keeps Claude's context accurate as your work evolves. A stale [CLAUDE.md](http://CLAUDE.md) produces stale answers. 
...
01 — Install Obsidian and create your five-folder structure Inbox, Notes, Ideas, Projects, and your [CLAUDE.md](http://CLAUDE.md) in the root. Do not add any other folders. Start simple and let the structure evolve from actual usage. 
...
04 — Write your [CLAUDE.md](http://CLAUDE.md) file Use the template above. Be specific and honest. The quality of Claude's output is directly proportional to the quality of the context you give it in this file. 
...
Follow @cyrilXBT for the exact N8N workflows, [CLAUDE.md](http://CLAUDE.md) templates, and weekly synthesis prompts behind this system — posted every week.
