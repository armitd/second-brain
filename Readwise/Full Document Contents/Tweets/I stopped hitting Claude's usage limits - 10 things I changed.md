...
![rw-book-cover](https://pbs.twimg.com/profile_images/2038207056776433664/ciAVXqXJ.jpg)

## Metadata
- Author: [[kaize]]
- Full Title: I stopped hitting Claude's usage limits - 10 things I changed
- Category: #tweets
- Summary: Claude counts tokens, not messages, so managing tokens wisely saves money and usage. To reduce token use, edit prompts instead of sending follow-ups, start fresh chats regularly, and batch questions into one message. Also, use features like Projects, memory settings, and choose simpler models for easy tasks to avoid wasting tokens.
- URL: https://twitter.com/0x_kaize/status/2038286026284667239/?rw_tt_thread=True

## Full Document
![I stopped hitting Claude's usage limits - 10 things I changed](https://pbs.twimg.com/media/HElLrcNbMAAcTRj.jpg)
...
![Image](https://pbs.twimg.com/media/HElOSEfaIAAAbwG.png) 
...
![Image](https://pbs.twimg.com/media/HElP2NxXkAANi-y.png) 
...
![Image](https://pbs.twimg.com/media/HEfv6mGXYAEI4Dv.jpg) 
