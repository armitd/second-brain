# this is how the founder of obsidian actually takes notes...

![rw-book-cover](https://pbs.twimg.com/profile_images/2005314466255360000/XtVoqVdV.jpg)

## Metadata
- Author: [[Rohit]]
- Full Title: this is how the founder of obsidian actually takes notes...
- Category: #tweets
- Summary: this is how the founder of obsidian actually takes notes in his own app.
...
- URL: https://twitter.com/rohit4verse/status/2054666206314213829/?rw_tt_thread=True
...
![How to Build an Obsidian Vault That Runs Your Entire Business While You Sleep - (Full Course)](https://pbs.twimg.com/media/HIJcu-uWMAAB5Vl.jpg)
...
#### The Master [CLAUDE.md](http://CLAUDE.md): Your Business Constitution

The [CLAUDE.md](http://CLAUDE.md) file in your SYSTEM folder is the single most important file in your entire business operating system. 
...
A poorly written [CLAUDE.md](http://CLAUDE.md) produces generic outputs that require significant editing. 

A precisely written [CLAUDE.md](http://CLAUDE.md) produces outputs that require minimal editing because the intelligence layer understands your business as well as you do. 

```
# Business Operating System — [CLAUDE.md](http://CLAUDE.md)## Business Identity  
...
- Log every write operation in SYSTEM/logs/[operations.md](http://operations.md).  
...
Save to: 08 - GENERATED/briefings/[DATE]-[CLIENT]-[precall.md](http://precall.md) 
...
Read all [overview.md](http://overview.md) files in 02 - PROJECTS.
...
Save to: 08 - GENERATED/briefings/[DATE]-[project-pulse.md](http://project-pulse.md) 
...
3. 03 - OPERATIONS/content/[calendar.md](http://calendar.md) for scheduled topics

4. Your content pillars from [CLAUDE.md](http://CLAUDE.md)
...
Save to: 08 - GENERATED/briefings/[DATE]-[content-brief.md](http://content-brief.md) 

**The Draft Engine** 

Drop a file in QUEUE named DRAFT-[content type]-[topic].md with any specific notes you want included. 

The queue processor picks it up, reads your research brief on the topic, applies your voice profile from [CLAUDE.md](http://CLAUDE.md), and produces a first draft in GENERATED/drafts. 
...
Save to: 08 - GENERATED/reports/[DATE]-[content-performance.md](http://content-performance.md) 
...
Read the monthly target from [CLAUDE.md](http://CLAUDE.md).
...
Save to: 08 - GENERATED/reports/[DATE]-[financial-brief.md](http://financial-brief.md) 
...
Save to: 08 - GENERATED/briefings/[DATE]-[intelligence.md](http://intelligence.md) 
...
Save to: 08 - GENERATED/reports/[DATE]-[weekly-review.md](http://weekly-review.md) 
...
Trigger → Read [CLAUDE.md](http://CLAUDE.md) → Read relevant vault content 

→ Call Claude API with compiled context → Write output 

to vault → Send notification → Log operation 

The Claude API call always includes the [CLAUDE.md](http://CLAUDE.md) content as system context. This is what makes every automated output business-specific rather than generic. 
...
Start with the [CLAUDE.md](http://CLAUDE.md) and the Morning Briefing workflow. 
...
[Posted May 13, 2026 at 1:54AM](https://twitter.com/cyrilXBT/status/2054379666316693719)

---

Interested in the full guide.
