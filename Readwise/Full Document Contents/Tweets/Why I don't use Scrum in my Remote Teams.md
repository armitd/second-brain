# Why I don't use Scrum in my Remote Teams?

![rw-book-cover](https://pbs.twimg.com/profile_images/1142324885550751744/wVNatx7J.png)

## Metadata
- Author: [[Sergio Pereira]]
- Full Title: Why I don't use Scrum in my Remote Teams?
- Category: #tweets
- Summary: The author explains why they don't use Scrum in their remote teams, highlighting that it adds at least 8 hours of meetings per sprint, resulting in a significant time waste. Instead, they advocate for an asynchronous approach, breaking down tasks into 5 important questions (Why, What, How, Who, When) that can be addressed sequentially in a collaborative document. They emphasize the reduction of meetings and the importance of deep work for productivity and team efficiency. The author also mentions that most Big Tech companies do not use Scrum and opt for a Plan > Build > Ship approach instead.
- URL: https://twitter.com/SergioRocks/status/1685999330543489024/?rw_tt_thread=True
...
Here I wrote more about 6 ways I replace meetings with async processes:

![](https://pbs.twimg.com/profile_images/1142324885550751744/wVNatx7J.png)

[Sergio Pereira](https://twitter.com/SergioRocks)
[@SergioRocks](https://twitter.com/SergioRocks)

Meetings are the worst!

They burn people out and nothing gets done.

As a CTO, these are 6 steps I follow to aggressively reduce meetings in my teams:

[Posted May 22, 2023 at 1:02PM](https://twitter.com/SergioRocks/status/1660632194698694656)
...
![](https://pbs.twimg.com/media/F2XfexGWAAAKH-d.jpg)

---

Usually the document is started by a business stakeholder. They define the "Why".

Eg of "Why": We need comply with regulations in the Healthcare sector, so we can expand our sales in that vertical.

---

From this "Why", a the team collaboratively crafts the What. It needs to be clear enough so that Engineers understand it, but flexible enough to take input around feasibility and implementation tradeoffs.

Eg of "What": Our data needs to be stored in HIPAA compliant servers.

---

The "How", "Who" and "When" are usually collaborative, and led by technical stakeholders, eg: a SWE.
...
Me 8 years ago (1st time CTO):  
- Worked 12+ hours a day  
- Managed my team during the day (clunky processes)  
- Coded at night (deep work)  
- Burned out

My current self:  
- Work 7-8 hours a day in bursts of productivity  
- Manage my teams async  
- Fit deep work during day  
- Energised

[Posted Oct 3, 2022 at 5:30PM](https://twitter.com/SergioRocks/status/1576988011576922121)

---

I wrote about this in last week's issue of my Remote Work Newsletter.

Read the full article here:  
[remote-work.io/newsletter/scr…](https://www.remote-work.io/newsletter/scrum-is-terrible-for-remote-teams/)

---

If you'd like to dig deeper.

My course "Mastering Remote Work" dives deeper into the processes I've used to manage my remote teams around the globe for the past 8 years:

[remote-work.io/course-masteri…](https://www.remote-work.io/course-mastering-remote-work/)

---

Interestingly, I learned that most Big Tech companies don't use Scrum either.

Instead, they use some variant of Plan > Build > Ship. I had never seen that coined as a process, but resonates a lot with my approach as well.

[newsletter.pragmaticengineer.com/p/project-mana…](https://newsletter.pragmaticengineer.com/p/project-management-in-tech)
