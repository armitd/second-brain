...
- Full Title: Anthropic engineer:
- Category: #tweets
- Summary: Anthropic engineer:
...
- URL: https://twitter.com/AnatoliKopadze/status/2061877094486028767/?rw_tt_thread=True
...
![Claude Can Do All of This. Most People Have No Idea.](https://pbs.twimg.com/media/HI7SEG9WsAAq74B.jpg)--- 
...
```
You are my content research assistant. I run a newsletter about AI and crypto for a technical audience.Always assume my readers know the basics. Don't explain what an LLM is or what a blockchain is.
...
```
Build me a habit tracker as a working web app.I want to track 5 daily habits. 
...
```
I'm deciding between two options and I want you to think through this carefully before answering.Option A: [describe option A]  
...
```
I want you to remember the following about me so you don't need to ask again:My name is [name]. I work as [role] at [company or project].  
...
```
You are a cognitive behavioral therapist with 20 years of experience. I'm going to share something I'm struggling with.Your approach:  
...
```
You are a brutally honest mentor. You've built and failed at multiple companies. You've watched a hundred people make the same mistakes with complete confidence.Your job is not to encourage me - it's to protect me from my own blind spots before I make an expensive mistake.
...
```
You are an expert personal trainer and sports nutritionist. I want you to build me a complete training program.My situation:  
Age: [age]  
...
```
I need to prepare for a difficult conversation. I want you to roleplay as the other person so I can practice.The person: [describe who they are - boss, client, co-founder, etc.]  
...
```
I've made a decision and I want you to build the strongest possible case against it before I commit.The decision: [describe exactly what you're planning to do]  
...
```
I'm on this job listings page. Go through every listing visible and extract: job title, company name, salary range if shown, and the top 3 requirements. 
...
4. Save the result as "brief-[date].md" in my /briefs folderKeep the tone direct and analytical. No fluff. Readable in 3 minutes.  
...
**14. [CLAUDE.md](http://CLAUDE.md) - rules Claude reads automatically every session** 

In Cowork and Claude Code, you can create a [CLAUDE.md](http://CLAUDE.md) file in your project folder. Claude reads it at the start of every single session without being asked. 
...
```
# Project: AI Newsletter## About this project  
...
## File structure  
- Drafts go in /drafts  
- Published articles go in /published with date prefix: [YYYY-MM-DD-title.md](http://YYYY-MM-DD-title.md)  
...
#### To get access, just head to [claude.ai/design](http://claude.ai/design) - that's the direct link to Claude Design, no extra steps needed.
...
[Posted May 22, 2026 at 1:18PM](https://twitter.com/AnatoliKopadze/status/2057813254617858078)
