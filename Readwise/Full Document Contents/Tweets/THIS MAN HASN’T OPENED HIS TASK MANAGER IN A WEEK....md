# THIS MAN HASN’T OPENED HIS TASK MANAGER IN A WEEK...

![rw-book-cover](https://pbs.twimg.com/profile_images/2033124141205692417/q3k-wGks.jpg)

## Metadata
- Author: [[leopardracer]]
- Full Title: THIS MAN HASN’T OPENED HIS TASK MANAGER IN A WEEK...
- Category: #tweets
- Summary: THIS MAN HASN’T OPENED HIS TASK MANAGER IN A WEEK AND HIS ENTIRE LIFE IS STILL ON TRACK
...
the only difference is one folder called CAPTURE and claude running at 8pm every night

every idea goes in and claude files it and nothing requires a decision and nothing gets lost
- URL: https://twitter.com/leopardracer/status/2057013987083002016/?rw_tt_thread=True

## Full Document
T**HIS MAN HASN’T OPENED HIS TASK MANAGER IN A WEEK AND HIS ENTIRE LIFE IS STILL ON TRACK**
...
![How to Turn Obsidian Into a Personal Operating System That Never Breaks Down](https://pbs.twimg.com/media/HIuW846WcAAHQJi.jpg)
...
**03 - SYSTEM** is the operating system itself. [CLAUDE.md](http://CLAUDE.md). Skill files. Workflow definitions. Logs. The infrastructure layer. 
...
#### The [CLAUDE.md](http://CLAUDE.md) That Makes It Intelligent

The [CLAUDE.md](http://CLAUDE.md) is the document that tells Claude everything about your life before any workflow runs. 
...
### Personal Operating System — [CLAUDE.md](http://CLAUDE.md)
...
* Log every significant action in SYSTEM/logs/[operations.md](http://operations.md).
...
Read [CLAUDE.md](http://CLAUDE.md) for full life context.
...
PROJECT PULSE: For each active project in [CLAUDE.md](http://CLAUDE.md):
...
Save to: GENERATED/briefings/[DATE]-[morning.md](http://morning.md) 
...
Log all processing actions in SYSTEM/logs/[capture-log.md](http://capture-log.md). 
...
Read [CLAUDE.md](http://CLAUDE.md) for current life context and priorities.
...
Save to: GENERATED/summaries/[DATE]-[weekly-review.md](http://weekly-review.md)

Update [CLAUDE.md](http://CLAUDE.md): Current Priorities section with next 
...
[RESEARCH-stoic-philosophy-applications.md](http://RESEARCH-stoic-philosophy-applications.md)

[SUMMARIZE-project-meeting-notes.md](http://SUMMARIZE-project-meeting-notes.md)

[DRAFT-email-to-landlord-about-repairs.md](http://DRAFT-email-to-landlord-about-repairs.md)

[PLAN-trip-to-portugal-october.md](http://PLAN-trip-to-portugal-october.md)

[DECIDE-whether-to-accept-new-client.md](http://DECIDE-whether-to-accept-new-client.md) 
...
Log all queue processing in SYSTEM/logs/[queue-log.md](http://queue-log.md).
...
Read [CLAUDE.md](http://CLAUDE.md) for the list of active projects.

Read the [overview.md](http://overview.md) file in each active project folder.
...
GENERATED/briefings/[DATE]-[project-health.md](http://project-health.md)
...
**The [CLAUDE.md](http://CLAUDE.md) Single Source of Truth** 
...
When your priorities change you update [CLAUDE.md](http://CLAUDE.md) and every subsequent workflow reflects the new reality automatically. You do not have to update five different documents or re-explain your situation in five different sessions. 
...
Create the eight folders. Set up the [CLAUDE.md](http://CLAUDE.md) with your actual current information. Write one project overview for your most active project with consistent properties. 

Time required: 2 hours. 

**Saturday Afternoon: Intelligence Layer** 

Install Claude Desktop. Configure the Filesystem MCP. Point it at your vault. Run the first morning briefing manually and verify it produces accurate output based on your [CLAUDE.md](http://CLAUDE.md). 
...
Let Claude process it. Review the output. Note what to improve in your [CLAUDE.md](http://CLAUDE.md). 
...
Follow @cyrilXBT for the exact [CLAUDE.md](http://CLAUDE.md) templates, N8N workflow configurations, and Filesystem MCP setup that makes this entire architecture run. 

[Posted May 20, 2026 at 2:26AM](https://twitter.com/cyrilXBT/status/2056924424838815824)
