...
![rw-book-cover](https://pbs.twimg.com/profile_images/2062191018670501888/M7jUEryG.jpg)

## Metadata
- Author: [[Hamza Khalid]]
- Full Title: How to Build Your Second Brain using Obsidian (FREE)
- Category: #tweets
- Summary: This tweet contains no text.
- URL: https://twitter.com/humzaakhalid/status/2062821175546515504/?rw_tt_thread=True

## Full Document
![How to Build Your Second Brain using Obsidian (FREE)](https://pbs.twimg.com/media/HKCKxlEa8AAe8ig.jpg)## The exact folders, plugins, and workflow I use - copy it. 
...
![Image](https://pbs.twimg.com/media/HKCKxeuacAAuIlK.jpg) 
...
![Image](https://pbs.twimg.com/media/HKCKxgUbcAAi1Qs.jpg) 
...
3. **The Graph View**: Every time you link two notes, Obsidian draws a line between them in the Graph View - a live visual of your entire knowledge base. Notes that connect to many others become hubs. Clusters of related ideas reveal themselves. You start to see patterns you didn’t know existed.![Image](https://pbs.twimg.com/media/HKCKxerbUAAOvZH.jpg)
...
* Click on the New Note icon in the top left corner or press Cmd+N (Mac) or Ctrl+N (Windows) to create a new note
* Title it with a clear name
* Write freely
* Repeat for two more notes
...
* Inside any note, type [[
* Start typing the name of another note
* Select it from the dropdown and press Enter
* That note is now linked
...
📁 Archive:      old or completed work, out of sight  

```
* Right-click in the left sidebar → New Folder
* Name it “Inbox.”
* Repeat for Notes, Projects, Archive
* Right-click on the Folder to add Notes, Canvas, bases, etc

Your browser does not support the video tag.  
***Every new note starts in the Inbox. You review it weekly and move it to its permanent home. This is called the PARA method, and it works in Obsidian perfectly.*** 
...
```
Your browser does not support the video tag.  
***Don’t install community plugins yet. Master the core tools first.*** 
...
* Create a folder called “Templates” in your vault
* Create a new note inside it called “Meeting Note Template.”
* Add this structure:
...
```
* In Settings → Core Plugins → Templates → set your Templates folder
* Now press Cmd+T Inside any note, insert a template

Your browser does not support the video tag.  
***A template you use every time is worth 100 complex systems you set up once and forget.*** 
...
* **Use** hashtags (#)  **for status, not topics:** Tags like # todo, # review, # waiting Let you filter notes by their position in your workflow. Topics belong in note titles and links, not tags.
* **Write note titles as full sentences:** “Why sleep affects memory consolidation” is 10x more useful than “Sleep notes.” Full sentences force clarity and make the graph view readable.
* **Link before you search:** If you reference something, link to it. Every [[link]] You make five minutes of future searching.
* **The 2-minute note rule:** If a note takes less than 2 minutes to create, do it now. Don’t bookmark. Don’t screenshot. Write the note, drop it in the inbox, and link it later.
* **Review your Inbox every Friday:** The Inbox is not permanent storage. Process it weekly - move, link, or delete. A full Inbox is a cluttered mind.
...
1. **Evergreen Note**: A permanent idea, written in your own words. The title is a full claim. Links to 3+ other notes.

```
# Consistent systems beat motivation every time  
The science behind habit formation shows...  
[[Why habits beat willpower]] | [[James Clear's framework]]  

```
2. **Meeting Note:** Use the template from Step 7. Fill in before and during. Link action items to project notes.
3. **Daily Note:** Date as title. Loose capture. Link freely. Process weekly.

```
# 2025-06-02  
Working on: [[Obsidian Newsletter Issue]]  
Idea: Daily notes are underrated because...  
Follow up: [[Content Pipeline Project]]  

```
4. **Project Note:** One note per active project. Top section = goal. Middle = running notes. Bottom = linked resources.

```
# Project: Q3 Content Calendar  
Goal: 12 newsletter issues planned by July 1## Status  
In progress

## Notes + Decisions

## Resources  
[[Newsletter Format Guide]] | [[Topic Ideas]]  

```
5. **Book/Article Note** Source → Key ideas → Your reaction → Links to your existing notes. 
...
Links: [[Why first drafts should be ugly]] | [[Zettelkasten method]]  
...
* **Building the system before using it:** The perfect folder structure means nothing if you have no notes. Write first. Organize later.
* **Treating it like a filing cabinet:** Obsidian is not Evernote. If you’re putting notes in folders and never linking them, you’re using a Ferrari as a parking spot.
* **Installing 30 community plugins in Week 1:** Every plugin adds friction and potential conflicts. Use core plugins for 30 days. Add community plugins only when you feel a specific gap.
* **Orphan notes:** A note that links to nothing is a note you’ll never find again. Every note should link to at least one other note before you close it.
* **Copying instead of writing:** Highlighting an article and pasting it into Obsidian is not note-taking. It’s digital hoarding. Write the idea in your own words. That’s when understanding happens.
* **Quitting after one week:** Obsidian compounds. At 100 notes, it feels useful. At 500 notes, it feels magical. The readers who quit after 20 notes never find out.![Image](https://pbs.twimg.com/media/HKCKxerbMAEqEmo.jpg)
...
* Paste into Claude
* Replace the text inside [ ] brackets with your own content
* Hit send.***Every prompt is designed to output Obsidian-ready Markdown. Paste the result directly into a new note.***
...
```
You are an expert at building a personal knowledge management system in Obsidian.I want to create an Evergreen Note from the following idea or source material:
...
End with: \*Created: {{date:YYYY-MM-DD}} | [[🏠 Home|🏠 Home]]\*  

```

---

#### Prompt 2: Literature Note Generator
...
```
You are helping me build a personal knowledge base in Obsidian.I just finished reading/watching/listening to this:
...
#### Prompt 3: Meeting Note Processor
...
```
You are helping me organise my notes in Obsidian.Here are my raw notes or transcript from a meeting:
...
#### Prompt 4: Daily Note Reflection Starter
...
```
You are helping me write today's Daily Note in Obsidian.Answer these 3 questions for me based on what I tell you:
...
End with: \*[[📥 Inbox|← Back to Inbox]] | [[🏠 Home|🏠 Home]]\*  

```

---

#### Prompt 5: Idea Connection Finder
...
```
I have two notes in my Obsidian vault and I want to understand how they connect.Note 1 title: [PASTE YOUR FIRST NOTE TITLE]  
...
5. Give me one question these two connected notes raise that I haven't answered yet.  
 This question should become my next Evergreen Note.  

```

---

#### Prompt 6: Article to Obsidian Note
...
```
I want to capture the key ideas from this article into my Obsidian vault.Article title: [ARTICLE TITLE]  
...
If this helped you, forward it. Most people will find this in three months. You found it today, pass it on while it's still early. 

That is how this list grows. Readers like you are sending it to people like them. 

I write my exclusive content in my [newsletter.](https://humzakhalid.substack.com/) Make sure to subscribe (It's free) 

And for shorter takes between issues, follow me on X →[Hamza Khalid](https://x.com/Whizz_ai) 
