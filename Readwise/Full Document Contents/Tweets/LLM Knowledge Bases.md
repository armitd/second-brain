...
- Full Title: LLM Knowledge Bases
- Category: #tweets
- Summary: Andrej Karpathy uses large language models (LLMs) to build and maintain personal knowledge bases as markdown wikis. He organizes and enhances data automatically with LLMs, then explores and queries it interactively in Obsidian. This approach helps answer complex questions and suggests new insights without manual editing.
- URL: https://twitter.com/karpathy/status/2039805659525644595/?rw_tt_thread=True
