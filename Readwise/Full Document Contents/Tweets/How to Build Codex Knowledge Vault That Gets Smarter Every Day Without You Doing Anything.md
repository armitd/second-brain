...
![rw-book-cover](https://pbs.twimg.com/profile_images/2009704432674426880/Q29hAGJR.jpg)

## Metadata
- Author: [[Ziwen]]
- Full Title: How to Build Codex Knowledge Vault That Gets Smarter Every Day Without You Doing Anything
- Category: #tweets
- Summary: This tweet contains no text.
- URL: https://twitter.com/ziwenxu_/status/2053241837453029439/?rw_tt_thread=True

## Full Document
![How to Build Codex Knowledge Vault That Gets Smarter Every Day Without You Doing Anything](https://pbs.twimg.com/media/HH6UjG7XIAEzy1I.jpg)
...
* **[AGENTS.md](http://AGENTS.md):** This is the master file Codex reads first. It’s the "Global Variable" of your life. It tells the AI exactly who you are, what your 2026 goals look like, and your non-negotiable rules like "Never give me boilerplate" or "Always check my /notes before suggesting anything."
...
* **Force the Update:** Don't just move files around. Every time you change the structure, go back to your [AGENTS.md](http://AGENTS.md) or your master system prompt and tell your agents: *"The map has changed. Here is the new logic for how we store and retrieve this specific data."*
...
```
"use @computer Navigate to my X Bookmarks. Extract the content of every thread saved in the last 24 hours. Strip out the ads and engagement bait. Convert the core insights into a clean Markdown file titled [YYYY-MM-DD-X-Insights.md](http://YYYY-MM-DD-X-Insights.md) and save it to my /inbox."  
...
```
"Audit all new files in the /inbox and /notes from the last 24 hours. Cross-reference them with our roadmap in [AGENTS.md](http://AGENTS.md).  
...
IMMEDIATE ACTION: Based on these upgrades, what is the single most high-leverage task for today? Update your internal memory and save the strategy to [DAILY-BRIEF.md](http://DAILY-BRIEF.md)."  
...
FIRMWARE UPGRADE: Rewrite the 'Core Logic' section of [AGENTS.md](http://AGENTS.md). Integrate everything we’ve learned this week so you start Monday morning as a more capable, more senior version of yourself."  
...
* **The "Plan-First" Checkpoint:** Never let an agent just start typing code. Force it to write a 3-sentence "Battle Plan" based on your current [AGENTS.md](http://AGENTS.md) before it touches the keyboard.
...
**Follow @ziwenxu\_ for the more tips, guide workflows, and weekly synthesis prompts behind this system. I'm posting every day.**
