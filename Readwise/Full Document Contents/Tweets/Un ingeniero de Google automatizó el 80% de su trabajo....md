# Un ingeniero de Google automatizó el 80% de su trabajo...

![rw-book-cover](https://pbs.twimg.com/profile_images/1971158245411622912/AxyPXVaS.jpg)

## Metadata
- Author: [[Nona]]
- Full Title: Un ingeniero de Google automatizó el 80% de su trabajo...
- Category: #tweets
- Summary: Un ingeniero de Google automatizó el 80% de su trabajo con 67 Claude Skills. Solo. Sin equipo. Por 20 dólares al mes.

Las empresas pagaban 200.000 dólares al año por lo que esta persona hace ahora desde su laptop en un café.

La lista exacta de skills que usó está abajo. Guárdala antes de que desaparezca.
- URL: https://twitter.com/Nona_xai/status/2044802529557668192/?rw_tt_thread=True

## Full Document
Un ingeniero de Google automatizó el 80% de su trabajo con 67 Claude Skills. Solo. Sin equipo. Por 20 dólares al mes.
...
![](https://pbs.twimg.com/profile_images/2022077728359682048/UWClPPZX.jpg)

[Mr. Buzzoni](https://twitter.com/polydao)
[@polydao](https://twitter.com/polydao)

![Top 67 Claude Skills That Turn a $20 Subscription Into a Full Dev Team - (Full Links)](https://pbs.twimg.com/media/HF6WmyBXkAErpHd.jpg)*Most people use Claude like a $20 autocomplete* 
...
**A skill is a folder with a *[SKILL.md](http://SKILL.md)* file that tells Claude exactly how to do a specific type of work:** step-by-step process, constraints, examples, and any helper scripts or templates 

Instead of re-explaining your process every session, you install that process once as a skill and reuse it forever

![Image](https://pbs.twimg.com/media/HF6kCqTaoAA0L3f.png) 
...
* Official Anthropic skills: [github.com/anthropics/skills](http://github.com/anthropics/skills)
* Matt Pocock personal skills (15k stars): [github.com/mattpocock/skills](http://github.com/mattpocock/skills)
* Community marketplace (66k+ skills): [skillsmp.com](http://skillsmp.com)
...
![Image](https://pbs.twimg.com/media/HF6jbvTWUAAjLdf.jpg) 

#### Skill Creator

* **What it does:** Benchmarks Claude on your task, then helps you draft and iterate new skills based on real runs.
* **Use it when:** You want to turn a messy workflow into one clean [SKILL.md](http://SKILL.md).
* **Link:** [github.com/anthropics/skills/tree/main/skills/skill-creator](http://github.com/anthropics/skills/tree/main/skills/skill-creator)

**How to use:** 

1. Describe your workflow in bullet points
2. Ask Skill Creator to propose a first *[SKILL.md](http://SKILL.md)*
...
* **Example marketplace:** [skillsmp.com](http://skillsmp.com)***Tip:** Treat "finding skills" like package management. Before you write a new skill, search for existing ones and fork them*
...
![Image](https://pbs.twimg.com/media/HF6c4ouXsAAICgG.jpg) 
...
* **Link:** [github.com/mattpocock/skills/tree/main/grill-me](http://github.com/mattpocock/skills/tree/main/grill-me)
...
* **Link:** [github.com/mattpocock/skills/tree/main/write-a-prd](http://github.com/mattpocock/skills/tree/main/write-a-prd)
...
* **Link:** [github.com/mattpocock/skills/tree/main/prd-to-plan](http://github.com/mattpocock/skills/tree/main/prd-to-plan)
...
* Link: [github.com/mattpocock/skills/tree/main/prd-to-issues](http://github.com/mattpocock/skills/tree/main/prd-to-issues)
...
* Link: [github.com/mattpocock/skills/tree/main/design-an-interface](http://github.com/mattpocock/skills/tree/main/design-an-interface)
...
* Link: [github.com/mattpocock/skills/tree/main/request-refactor-plan](http://github.com/mattpocock/skills/tree/main/request-refactor-plan)
...
![Image](https://pbs.twimg.com/media/HF6dVPnaEAAF9tu.jpg) 
...
* Link: [github.com/mattpocock/skills/tree/main/tdd](http://github.com/mattpocock/skills/tree/main/tdd)
...
* Link: [github.com/mattpocock/skills/tree/main/triage-issue](http://github.com/mattpocock/skills/tree/main/triage-issue)
...
* Link: [github.com/mattpocock/skills/tree/main/qa](http://github.com/mattpocock/skills/tree/main/qa)
...
* Link: [github.com/mattpocock/skills/tree/main/improve-codebase-architecture](http://github.com/mattpocock/skills/tree/main/improve-codebase-architecture)
...
* Link: [github.com/mattpocock/skills/tree/main/migrate-to-shoehorn](http://github.com/mattpocock/skills/tree/main/migrate-to-shoehorn)
...
* Link: [github.com/mattpocock/skills/tree/main/scaffold-exercises](http://github.com/mattpocock/skills/tree/main/scaffold-exercises)
...
* **Link:** [github.com/anthropics/skills/tree/main/skills/auto-commit](http://github.com/anthropics/skills/tree/main/skills/auto-commit)
...
* Link: [github.com/anthropics/skills](http://github.com/anthropics/skills) (search Code Review)

**You can ask for:** 

* "Security-first review"
* "Performance-first review"
* Or a full checklist pass![Image](https://pbs.twimg.com/media/HF6dvytasAE6mnh.jpg)
...
* Link: [github.com/obra/superpowers/tree/main/skills/systematic-debugging](http://github.com/obra/superpowers/tree/main/skills/systematic-debugging)
...
* Link: [github.com/obra/superpowers/tree/main/skills/brainstorming](http://github.com/obra/superpowers/tree/main/skills/brainstorming)
...
* Link: [github.com/ComposioHQ/awesome-claude-skills/tree/master/changelog-generator](http://github.com/ComposioHQ/awesome-claude-skills/tree/master/changelog-generator)
...
* Link: [mcpmarket.com/tools/skills/simplification-cascades-1](http://mcpmarket.com/tools/skills/simplification-cascades-1)
...
* Link: [github.com/obra/superpowers](http://github.com/obra/superpowers)
...
* Link: [github.com/vercel-labs/agent-skills/tree/main/skills/react-best-practices](http://github.com/vercel-labs/agent-skills/tree/main/skills/react-best-practices)
...
* Link: [github.com/massgen/massgen](http://github.com/massgen/massgen)
...
* Link: [github.com/muratcankoylan/agent-skills-for-context-engineering](http://github.com/muratcankoylan/agent-skills-for-context-engineering)
...
* Link: [github.com/mattpocock/skills/tree/main/setup-pre-commit](http://github.com/mattpocock/skills/tree/main/setup-pre-commit)

Run this on every new repo. Your future self will thank you.

![Image](https://pbs.twimg.com/media/HF6eF7easAE2iEA.jpg) 
...
* Link: [github.com/mattpocock/skills/tree/main/git-guardrails-claude-code](http://github.com/mattpocock/skills/tree/main/git-guardrails-claude-code)
...
* **Link:** [github.com/ComposioHQ/awesome-claude-skills](http://github.com/ComposioHQ/awesome-claude-skills)
...
* Link: [github.com/mattpocock/skills/tree/main/github-triage](http://github.com/mattpocock/skills/tree/main/github-triage)

**Use it to:** 

* Process large issue backlogs fast
* Label and categorize automatically
* Route issues to the right person or epic![Image](https://pbs.twimg.com/media/HF6enlbXAAAkTJ9.jpg)
...
* Link: [github.com/mattpocock/skills/tree/main/edit-article](http://github.com/mattpocock/skills/tree/main/edit-article)
...
* Link: [github.com/mattpocock/skills/tree/main/ubiquitous-language](http://github.com/mattpocock/skills/tree/main/ubiquitous-language)
...
* Link: [github.com/ComposioHQ/awesome-claude-skills/blob/master/content-research-writer/SKILL.md](http://github.com/ComposioHQ/awesome-claude-skills/blob/master/content-research-writer/SKILL.md)
...
* Link: [github.com/mattpocock/skills/tree/main/obsidian-vault](http://github.com/mattpocock/skills/tree/main/obsidian-vault)
...
**Also available:** [github.com/kepano/obsidian-skills](http://github.com/kepano/obsidian-skills) - the auto-tagging variant

![Image](https://pbs.twimg.com/media/HF6fyMkbwAAG7NV.jpg) 
...
* Link: [github.com/anthropics/skills/tree/main/skills/frontend-design](http://github.com/anthropics/skills/tree/main/skills/frontend-design)
...
* Link: [github.com/VoltAgent/awesome-design-md](http://github.com/VoltAgent/awesome-design-md)
...
* Link: [github.com/anthropics/skills/tree/main/skills/theme-factory](http://github.com/anthropics/skills/tree/main/skills/theme-factory)
...
* Link: [github.com/anthropics/skills/tree/main/skills/canvas-design](http://github.com/anthropics/skills/tree/main/skills/canvas-design)
...
* Link: [github.com/anthropics/skills/tree/main/skills/web-artifacts-builder](http://github.com/anthropics/skills/tree/main/skills/web-artifacts-builder)
...
* Link: [github.com/anthropics/skills/tree/main/skills/algorithmic-art](http://github.com/anthropics/skills/tree/main/skills/algorithmic-art)
...
* Link: [github.com/anthropics/skills/tree/main/skills/brand-guidelines](http://github.com/anthropics/skills/tree/main/skills/brand-guidelines)![Image](https://pbs.twimg.com/media/HF6gOf0WgAAu8Wv.jpg)
...
* Link: [github.com/Microck/ordinary-claude-skills/tree/main/skills\_all/domain-name-brainstormer](http://github.com/Microck/ordinary-claude-skills/tree/main/skills_all/domain-name-brainstormer)
...
* Link: [github.com/wshobson/agents/tree/main/plugins/payment-processing/skills/stripe-integration](http://github.com/wshobson/agents/tree/main/plugins/payment-processing/skills/stripe-integration)
...
* Link: [github.com/ComposioHQ/awesome-claude-skills/blob/master/lead-research-assistant/SKILL.md](http://github.com/ComposioHQ/awesome-claude-skills/blob/master/lead-research-assistant/SKILL.md)
...
* Link: [github.com/coreyhaines31/marketingskills](http://github.com/coreyhaines31/marketingskills)
...
* Link: [github.com/AgriciDaniel/claude-seo](http://github.com/AgriciDaniel/claude-seo)
...
* Install: *npx skills@latest add AgriciDaniel/claude-youtube*![Image](https://pbs.twimg.com/media/HF6g2TZXYAA6mBJ.jpg)
...
* Nano Banana Pro: [github.com/feedtailor/ccskill-nanobanana](http://github.com/feedtailor/ccskill-nanobanana)
* Nano Banana 2: [github.com/kingbootoshi/nano-banana-2-skill](http://github.com/kingbootoshi/nano-banana-2-skill)
...
* Link: [github.com/jezweb/claude-skills/blob/main/plugins/design-assets/skills/ai-image-generator/SKILL.md](http://github.com/jezweb/claude-skills/blob/main/plugins/design-assets/skills/ai-image-generator/SKILL.md)
...
* Link: [mcpmarket.com/tools/skills/image-optimizer](http://mcpmarket.com/tools/skills/image-optimizer)
...
* Link: [github.com/remotion-dev/remotion](http://github.com/remotion-dev/remotion)
...
* Link: [github.com/wilwaldon/Claude-Code-Video-Toolkit](http://github.com/wilwaldon/Claude-Code-Video-Toolkit)![Image](https://pbs.twimg.com/media/HF6hIzoXcAA6Iqu.jpg)
...
* Link: [github.com/anthropics/skills/tree/main/skills/pdf](http://github.com/anthropics/skills/tree/main/skills/pdf)

#### DOCX

* Purpose: Edits Word docs with tracked changes and formatting intact
* Link: [github.com/anthropics/skills/tree/main/skills/docx](http://github.com/anthropics/skills/tree/main/skills/docx)

#### PPTX

* Purpose: Creates and edits slide decks, layouts, and speaker notes
* Link: [github.com/anthropics/skills/tree/main/skills/pptx](http://github.com/anthropics/skills/tree/main/skills/pptx)

#### XLSX

* Purpose: Writes formulas, pivot tables, and charts from plain English
* Link: [github.com/anthropics/skills/tree/main/skills/xlsx](http://github.com/anthropics/skills/tree/main/skills/xlsx)

#### Excel MCP Server

* Purpose: Manipulates Excel files directly via MCP, no desktop Excel required
* Link: [github.com/haris-musa/excel-mcp-server](http://github.com/haris-musa/excel-mcp-server)

#### Doc Co-Authoring

* Purpose: Real-time collaborative writing between you and Claude
* Link: [github.com/anthropics/skills/tree/main/skills/doc-coauthoring](http://github.com/anthropics/skills/tree/main/skills/doc-coauthoring)

#### NotebookLM Integration

* Purpose: Bridges Claude with Google's NotebookLM for summaries and flashcards
* Link: [github.com/PleasePrompto/notebooklm-skill](http://github.com/PleasePrompto/notebooklm-skill)
...
* Link: <https://github.com/googleworkspace/cli>![Image](https://pbs.twimg.com/media/HF6hqdsXoAAcftJ.jpg)
...
* Link: [github.com/hungv47/meta-skills](http://github.com/hungv47/meta-skills)
...
* Link: [github.com/tommasinigiovanni/conclave](http://github.com/tommasinigiovanni/conclave)
...
* Link: [github.com/ZeroPointRepo/youtube-skills/blob/main/README.md](http://github.com/ZeroPointRepo/youtube-skills/blob/main/README.md)
...
* Link: [github.com/mendableai/firecrawl](https://github.com/mendableai/firecrawl)![Image](https://pbs.twimg.com/media/HF6iHpWXwAAipSI.jpg)
...
4. **Add Superpowers as your engineering base -** [github.com/obra/superpowers](http://github.com/obra/superpowers)
5. **Layer business skills on top** - Marketing Skills, Claude SEO, Lead Research, Content Researcher.
6. **Use SkillsMP to fill gaps** - [skillsmp.com](http://skillsmp.com) - when you hit a new problem, search before you build![Image](https://pbs.twimg.com/media/HF6iRLtWMAAp6SN.png)
...
If this saved you time - repost it. Someone on your timeline is still writing 500-word prompts to get what a single [SKILL.md](http://SKILL.md) does automatically

Follow me @polydao for more posts on Claude, AI tools, prediction markets, and what's actually worth your time in crypto 

[Posted Apr 15, 2026 at 7:32AM](https://twitter.com/polydao/status/2044317956893471081)
