...
![rw-book-cover](https://pbs.twimg.com/profile_images/2017556052938788865/3E6CcSFP.jpg)

## Metadata
- Author: [[Nav Toor]]
- Full Title: How to set up Claude Cowork the right way(so it actually does your work while you step away)
- Category: #tweets
- Summary: Claude Cowork is a smart desktop tool that reads your files and asks questions to get work done without guessing. It uses five key features like file access, plugins, and instructions to remember how you work and connect to your tools. Setting it up with clear context and global instructions helps Claude do about 60% of knowledge work while you step away.
- URL: https://x.com/heynavtoor/status/2026717574776631556/?s=12&t=iGBahVZb08SpJ-immXsWdQ&rw_tt_thread=True

## Full Document
![How to set up Claude Cowork the right way(so it actually does your work while you step away)](https://pbs.twimg.com/media/HCBY0GSaMAEunwU.jpg)--- 
...
Most people think Claude is like ChatGPT. A text box. You type, it responds. That’s [claude.ai](http://claude.ai) — the browser version. 
...
1. Go to [claude.com/download](http://claude.com/download). Download the desktop app (macOS or Windows x64).
...
* [about-me.md](http://about-me.md) — who you are, what you do, your role, what success looks like in your work
* [brand-voice.md](http://brand-voice.md) — how you communicate. Your phrases. What sounds wrong to you. Examples of writing you’re proud of.
* [working-style.md](http://working-style.md) — how you like Claude to behave. Do you want questions first? Short or long outputs? Which file formats?
...
3. Or go to [claude.com/plugins](http://claude.com/plugins) to see everything available.
...
*/marketing:draft-content Write a LinkedIn post about [topic]. Match the voice from my [brand-voice.md](http://brand-voice.md) file. Target [audience]. Goal: [what I want people to do].* 
...
Go to [claude.com/download](http://claude.com/download). Download the desktop app. Sign in or create an account. Get Pro ($20/month). Open the app. Find the Cowork tab at the top. You’re in. 
...
* [about-me.md](http://about-me.md): Who you are. What you do. One example of work you’re proud of.
* [brand-voice.md](http://brand-voice.md): How you communicate. Phrases you use. What sounds wrong. Tone.
* [working-style.md](http://working-style.md): How you want Claude to behave. Questions first? Short or long outputs? Preferred formats?
