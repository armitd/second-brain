# Me hyping you up to build your own second brain

![rw-book-cover](https://pbs.twimg.com/profile_images/1614514579098275840/6dgPShU3.jpg)

## Metadata
- Author: [[Nick Spisak]]
- Full Title: Me hyping you up to build your own second brain
- Category: #tweets
- Summary: Me hyping you up to build your own second brain

The setup is simple: 
→ The 3-folder structure (takes 2 minutes to set up) 
→ How to auto-scrape web articles into your knowledge base with agent-browser 
→ The one-file "schema" that makes the whole system work 
→ The exact prompts to compile your first wiki 
→ The compounding trick that makes it smarter every time you use it

Give this article to your AI clanker and tell it to build you a plan.
- URL: https://twitter.com/NickSpisak_/status/2040506186911379879/?rw_tt_thread=True
...
[Nick Spisak](https://twitter.com/NickSpisak_)
[@NickSpisak\_](https://twitter.com/NickSpisak_)

![How to Build Your Second Brain](https://pbs.twimg.com/media/HFEgzdzaMAAsz3P.jpg)
...
6. The health check that catches mistakes before they pile upFollow @NickSpisak\_ for practitioner-level AI implementation and Claude Code architecture content.
...
Create a file in the root of your project called [CLAUDE.md](http://CLAUDE.md) (or [AGENTS.md](http://AGENTS.md) or [README.md](http://README.md) - the name doesn't matter, the content does). This file tells your AI what the knowledge base is about and how to organize it. 
...
- Maintain an [INDEX.md](http://INDEX.md) in wiki/ that lists every topic with a one-line description  
...
```
@karpathy confirmed he keeps his schema "super simple and flat" in an [AGENTS.md](http://AGENTS.md) file. No database. No plugin. Just a text file that tells the AI the rules. 

This is the equivalent of what I use [CLAUDE.md](http://CLAUDE.md) for across every project. It's the AI's instruction manual for your specific knowledge base. 
...
"Read everything in raw/. Then compile a wiki in wiki/ following the rules in [CLAUDE.md](http://CLAUDE.md). Create an [INDEX.md](http://INDEX.md) first, then create one .md file per major topic. Link related topics. Summarize every source." 
...
[Posted Apr 4, 2026 at 3:16PM](https://twitter.com/NickSpisak_/status/2040448463540830705)
