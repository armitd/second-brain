...
## Metadata
- Author: [[AI Edge]]
- Full Title: How to Give Claude Perfect Memory (complete guide)
- Category: #tweets
- Summary: Claude's memory can be improved using three layers: direct prompts, importing/exporting context, and a deep wiki system with tools like Obsidian. This system lets Claude build, update, and link notes automatically, creating a powerful, evolving knowledge base. Using these methods makes Claude smarter and helps you keep important information connected and easy to access.
- URL: https://twitter.com/aiedge_/status/2046966170868486512/?rw_tt_thread=True

## Full Document
![How to Give Claude Perfect Memory (complete guide)](https://pbs.twimg.com/media/HF-3jVEbEAEGNmK.jpg)
...
![Image](https://pbs.twimg.com/media/HF-uYAPaUAA5Zii.jpg) 

2. **Project Instructions**

If you use Claude Projects (you should), you need to fill in your Project Instructions field.

![Image](https://pbs.twimg.com/media/HF-vLUsagAAEkaL.jpg) 
...
![Image](https://pbs.twimg.com/media/HF-wmMibEAAUdu5.jpg) 
...
Your browser does not support the video tag.As I mentioned above, you can just get Claude to create this for you. 
...
[Instructions.md](http://Instructions.md) — includes sections for: Who You Are, What You Do, Rules, What Good Outputs Look Like, and a line telling Claude to update [Memory.md](http://Memory.md) with my preferences over time.  
[Memory.md](http://Memory.md) — includes sections for: Preferences, Corrections, Patterns, Decisions, and Personal Context. Pre-fill with placeholder examples so I know what to add.  
[Context.md](http://Context.md) — includes sections for: About This Project/Business, Audience, Key People & Collaborators, Active Projects & Priorities, Tools & Stack, and Important Background/History. Use a template format with placeholders I can fill in.  
[Archive-Guide.md](http://Archive-Guide.md) — a step-by-step guide explaining why to archive, how to do it weekly (duplicate the folder, rename with the date, move it somewhere Claude can't access), what to include, how to restore if something breaks, and where to store the backups.  
...
![Image](https://pbs.twimg.com/media/HF-7JQqbUAAoxYl.png) 
...
![Image](https://pbs.twimg.com/media/HF-7qrPbEAEs_CP.jpg) 
...
Go to [obsidian.md](http://obsidian.md) and download the app. 
...
*[gist.github.com/karpathy/442a6bf555914893e9891c11519de94f](http://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f)* 
...
![Image](https://pbs.twimg.com/media/HF-96wMbEAER5Wy.jpg) 
...
![](https://pbs.twimg.com/profile_images/1910271186442846208/vrYKSYRn.jpg)

[AI Edge](https://twitter.com/aiedge_)
[@aiedge\_](https://twitter.com/aiedge_)
...
[Posted Apr 8, 2026 at 3:56PM](https://twitter.com/aiedge_/status/2041908011078447222)
