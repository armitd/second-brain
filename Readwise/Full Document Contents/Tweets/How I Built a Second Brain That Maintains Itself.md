# How I Built a Second Brain That Maintains Itself

![rw-book-cover](https://pbs.twimg.com/profile_images/2060362014107500549/mD7eJSC2.jpg)

## Metadata
- Author: [[wandermist]]
- Full Title: How I Built a Second Brain That Maintains Itself
- Category: #tweets
- Summary: This tweet contains no text.
- URL: https://twitter.com/wandermist/status/2070454234189893747/?rw_tt_thread=True

## Full Document
![How I Built a Second Brain That Maintains Itself](https://pbs.twimg.com/media/HLu40WjXwAASj0i.jpg)
...
![Image](https://pbs.twimg.com/media/HLu5WuWXkAAPl1L.jpg) 
...
“Here is Andrej Karpathy’s [LLM Wiki pattern](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f). Please implement this as my personal knowledge base in this Obsidian vault. Create the full directory structure, the [CLAUDE.md](http://CLAUDE.md) schema file, the index, the log, and all templates. Use [his gist](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) as the first source to ingest.” 
...
* Write a complete [CLAUDE.md](http://CLAUDE.md) schema file with all the rules, page types, and workflows
* Create the index and activity log
* Ingest the gist itself as the first source
* Build out entity and concept pages from the gist content![Image](https://pbs.twimg.com/media/HLu5gubWYAAxCSR.jpg)
