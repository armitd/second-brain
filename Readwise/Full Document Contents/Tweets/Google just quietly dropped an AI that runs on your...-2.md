# Google just quietly dropped an AI that runs on your...

![rw-book-cover](https://pbs.twimg.com/profile_images/2002604128628006912/0_lzJ6TR.jpg)

## Metadata
- Author: [[Beginnersblog]]
- Full Title: Google just quietly dropped an AI that runs on your...
- Category: #tweets
- Summary: Google just quietly dropped an AI that runs on your Mobile and doesn't need the internet.
...
→ Can't chain multiple steps together (yet) → Struggles with indirect requests → 85% accuracy means 15% err...
- URL: https://twitter.com/beginnersblog1/status/2002255879304073512/?rw_tt_thread=True
...
![](https://pbs.twimg.com/media/G8lp6fKagAAqEo6.jpg)

---

I have a Newsletters that covers practical AI tools, real use cases, and side-hustle systems people are using right now to earn online. 

More than 5000 readers already joined it...

JOIN HERE: [openailearning.org/subscribe/](https://openailearning.org/subscribe/)
