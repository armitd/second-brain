...
- Full Title: Subscriptions, licenses, accounts, and tenants for Microsoft's cloud offerings
- Category: #articles
- Summary: Microsoft provides a hierarchy of organizations, subscriptions, licenses, and user accounts for consistent use of identities and billing across its cloud offerings: Microsoft 365 and Microsoft Office 365 Microsoft Azure Microsoft Dynamics 365 Elements of the hierarchy Here are the elements of the hi
...
1. [Elements of the hierarchy](https://learn.microsoft.com/en-us/microsoft-365/enterprise/subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings?view=o365-worldwide#elements-of-the-hierarchy)
2. [Combining subscriptions for multiple Microsoft cloud offerings](https://learn.microsoft.com/en-us/microsoft-365/enterprise/subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings?view=o365-worldwide#combining-subscriptions-for-multiple-microsoft-cloud-offerings)
3. [See also](https://learn.microsoft.com/en-us/microsoft-365/enterprise/subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings?view=o365-worldwide#see-also)
4. [Next step](https://learn.microsoft.com/en-us/microsoft-365/enterprise/subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings?view=o365-worldwide#next-step)
...
![An example organization with multiple subscriptions for Microsoft's cloud offerings.](https://learn.microsoft.com/en-us/microsoft-365/media/subscriptions/subscriptions-fig1.png?view=o365-worldwide)
##### Licenses
...
![An example of multiple licenses within subscriptions for Microsoft's SaaS-based cloud offerings.](https://learn.microsoft.com/en-us/microsoft-365/media/subscriptions/subscriptions-fig2.png?view=o365-worldwide)
Note
...
![An example organization with multiple subscriptions all using the same Microsoft Entra tenant.](https://learn.microsoft.com/en-us/microsoft-365/media/subscriptions/subscriptions-fig3.png?view=o365-worldwide)
##### Tenants
...
![Identity as a Service (IaaS) IDaaS for your organization.](https://learn.microsoft.com/en-us/microsoft-365/media/subscriptions/subscriptions-fig4.png?view=o365-worldwide)
...
If you purchased Azure and Microsoft 365 subscriptions separately and want to access the Microsoft 365 Microsoft Entra tenant from your Azure subscription, see the instructions in [Add an existing Azure subscription to your Microsoft Entra tenant](https://learn.microsoft.com/en-us/azure/active-directory/fundamentals/active-directory-how-subscriptions-associated-directory).

#### See also

[Microsoft cloud for enterprise architects illustrations](https://learn.microsoft.com/en-us/microsoft-365/solutions/cloud-architecture-models?view=o365-worldwide)

[Architectural models for SharePoint, Exchange, Skype for Business, and Lync](https://learn.microsoft.com/en-us/microsoft-365/enterprise/architectural-models-for-sharepoint-exchange-skype-for-business-and-lync?view=o365-worldwide)

[Hybrid solutions](https://learn.microsoft.com/en-us/microsoft-365/enterprise/hybrid-solutions?view=o365-worldwide)
