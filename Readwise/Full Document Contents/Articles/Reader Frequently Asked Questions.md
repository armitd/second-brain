...
- Category: #articles
- Summary: The Reader app allows users to save and highlight articles from the web, syncing all highlights with Readwise and note-taking apps. You can import articles from Instapaper or Pocket, and the app offers a keyboard shortcut-driven experience on the web. Highlights made in the Reader browser extension will sync with the Reader app, ensuring your notes are always accessible.
...
>  ##### April 2, 2026
> 
>  * Add URL-based saving FAQ in **Adding Content to Reader** section
> * Add bulk restore from Trash FAQ in **Basics** section
> * Add colored dot status indicators FAQ in **Basics** section
> 
>  ##### March 6, 2026
> 
>  * Add FAQ about where the Listen button is in long-form reading mode in **Text-to-Speech (TTS)** section
> * Add side panel open/close FAQ in **Appearance** section
> * Update tagged highlights FAQ with new Manage Tags page features in **Highlights, Tags, and Notes** section
> * Update bundle sharing FAQ and add bundle refresh FAQ in **Sharing** section
> * Update Apple Pencil FAQ and add two-column tablet view FAQ in **Appearance** and **Highlights, Tags, and Notes** sections
> * Add offline document caching FAQ in **Basics** section
> * Overhaul **Text-to-Speech (TTS)** section: replace misalignment FAQ with return/jump button FAQs, move and expand languages FAQ
> * Add Ghostreader disable toggle FAQ in **Ghostreader** section
> * Add RSS feed refresh interval FAQ in **Feed** section
> * Add PDF auto-highlighting FAQ in **PDFs** section
> 
>  ##### December 16, 2025
> 
...
The selective offline caching feature allows you to choose which sections of your account are downloaded to your device's local storage for offline use. You can find the option in your Account tab under **Offline documents**.

![Open the Offline Documents menu in the Reader settings.](https://docs.readwise.io/images/settings_offline-documents.png)
In the **Offline documents** menu, you can select which sections of your account you would like to be cached for offline use. By default, the Feed is turned off and not cached, since this is the most common cause of app size bloat among our users.

Turning off a given section of your documents will remove the cached files for those documents.

![Cache files are removed when the toggle is turned off.](https://docs.readwise.io/images/offline-documents_toggle-off.gif)
To download the files for a section that was turned off, turn the toggle on. You might need to wait for a few moments as the files download, but you'll be able to see the progress in the bar below the toggle.

![Cache files download once the toggle is turned on.](https://docs.readwise.io/images/offline-documents_toggle-on.gif)
Utilizing these options will help you manage the file size of the Reader app on your device, as well as ensure that the full text of the documents you want to read are available for the next time you go offline.

>  **Note:** Individual documents will still be cached when you open them. This may result in unexpected numbers on the caching screen, e.g. "*10/300 downloaded*" for a section that is turned off.
> 
>  
...
##### What do the colored dots on documents mean?

The small dots that appear on document thumbnails in the list view are status indicators. On web, Reader uses three colors:

* **Dark blue** — The document is unseen (you haven't opened it yet, or you've manually marked it as unseen). This appears on articles, emails, PDFs, and other manually saved content.
* **Teal** — The document is unseen and comes from an RSS feed. The distinct color lets you tell feed items apart from the rest of your library at a glance.
* **Green** — The document has been saved to your library more than once.

![Status dot color indicators on documents in the Reader list view.](https://docs.readwise.io/images/doc-status-indicators_web.png)
Once you open a document, the dot will disappear.
...
##### I bulk deleted a bunch of documents and now I want them back. Can I restore all of my deleted items?

If you used a [bulk action](https://blog.readwise.io/reader/docs/faqs/highlights-tags-notes#how-do-i-select-multiple-items-to-perform-actions-in-bulk) to delete an entire list of documents at once but then decided you actually wanted to be a bit more discerning than such wanton removal, it's no fun to restore those documents one at a time.

To restore all of your documents on web, click into the Trash in the left hand sidebar, then click **Restore all** in the lower left corner.

![Restore all documents from trash on web.](https://docs.readwise.io/images/trash_restore-all_web.gif)
On mobile, tap into the **View** tab and scroll to the bottom to find the Trash. Then tap **Restore all** in the lower left.

![Restore all documents from trash on mobile.](https://docs.readwise.io/images/trash_restore-all_mobile.gif)
...
>  **Tip:** This format works great as a [Raycast Quicklink](https://www.raycast.com/features/quicklinks), a custom search engine shortcut in your browser, or as a step in an automation workflow.
> 
>  
...
![Use the Apple Pencil to naturally make highlights in Reader.](https://docs.readwise.io/images/apple-pencil.gif)

>  **Note:** PDFs in original view don't have this smooth stylus support yet, but if you [switch over to the text view](https://blog.readwise.io/reader/docs/faqs/pdfs#how-do-i-customize-the-appearance-of-a-pdf-while-reading) it will work great.
> 
>  
...
On web or in the desktop app, you can find a list of all the tags you've applied to highlights on the [Highlights tab of the Manage Tags page](https://read.readwise.io/highlights-tags).

![Highlight tab of the Manage Tags page in Reader.](https://docs.readwise.io/images/highlight-tags_tab.gif)
...
![Navigate between highlights with the arrow keys.](https://docs.readwise.io/images/highlight-tags_arrows.gif)
...
![Use the table of contents to navigate highlights.](https://docs.readwise.io/images/highlight-tags_toc.gif)
...
##### Can I close the side panels when I'm reading on web?

Whether you're using Reader on a device with a smaller screen or just want less clutter in your view while reading, closing the side panels is a handy trick for getting some extra screen real estate.

To collapse the table of contents (the left side panel), click the **Hide left panel** button in the top left or use the keyboard shortcut `[`.

![Icon to close the left side panel of Reader's reading view.](https://docs.readwise.io/images/side-panel_close-left_web.png)
To collapse the right side panel (containing Info, Notebook, and Chat), click the **Hide right panel** button in the top right corner or use the keyboard shortcut `]`.

![Icon to close the right side panel of Reader's reading view.](https://docs.readwise.io/images/side-panel_close-right_web.png)
If you'd like either of the side panels (or both!) to be closed by default whenever you open a document, you can go to your [account preferences](https://read.readwise.io/preferences) and set the **Side panel visibility by default** setting to whichever option you prefer: both panels hidden, left panel hidden, or right panel hidden.

![Side panel visibility default settings for Reader.](https://docs.readwise.io/images/side-panel_defaults_web.png)
To return the setting to its default state, select the "Both panels visible" option.
...
##### How can I view my document text in two columns on a tablet?

To view the text of your document in two side-by-side columns when reading on a tablet, open the **Appearance** panel and select "Horizontal pagination" in the **Pagination** section.

![Horizontal pagination setting in the Reader Appearance panel.](https://docs.readwise.io/images/horizontal-pagination_tablet.png)
Note that the two-column view will only work if your device is in landscape (horizontal) orientation. When oriented vertically, the screen width will be too small for the two-column view to display and it will revert to a single column.

>  **Tip:** To make the visual line between the columns a bit sharper (and to make it feel more like reading a real book), you might also like to turn on [justified text](https://blog.readwise.io/reader/docs/faqs/eink#justify-text) while reading in this view.
> 
>  
...
##### How often does Reader refresh my RSS feeds?

Reader checks for new RSS content approximately every 5 minutes. That said, this doesn't always happen proactively, as feeds with fewer subscribers may only refresh when you open the app, rather than on a fixed schedule.

If you're not seeing recent content, you can trigger a refresh manually. On web, you can do this by refreshing the browser tab with `cmd/ctrl + R`. On mobile, pull down from the top of the feed list until you see a loading icon.
...
##### Why doesn't the auto-highlighting option appear when I'm reading a PDF?

The auto-highlighting option isn't available in the default PDF view. Reader uses a specialized service to render PDFs, which means some features available for other types of documents (including auto-highlighting) don't work in this mode.

To use auto-highlighting on a PDF, you'll need to first switch to **Text view**.

To do this on web, click the `Text view` icon in the top left corner of the document. On mobile, tap **...** > **View as text**.

Once you're in text view, the auto-highlighting option will appear and work as expected.
...
##### Where is the Listen button when reading a book or EPUB?

In [long-form reading mode](https://docs.readwise.io/reader/docs/faqs/appearance#is-there-a-way-to-make-the-reading-view-nicer-for-long-documents-and-ebooks) (the default view for EPUBs), the Listen button in the top right is replaced by the Appearance menu. To start TTS, open the **...** menu in the bottom right, then tap **Listen**.

![Three-dot actions menu in long-form reading mode showing the Listen button.](https://docs.readwise.io/images/reader-tts_longform-listen-menu.png)
...
![Return button on TTS playback bar in Reader.](https://docs.readwise.io/images/tts_return_mobile.png)
Once you've returned, it will go back to following along with the text-to-speech until you scroll away again.

![Use the return button to go back to your TTS position.](https://docs.readwise.io/images/tts_return.gif)
...
![Use the jump button to change your current TTS playback position.](https://docs.readwise.io/images/tts_jump.gif)
...
![Waveform icon to change TTS voice.](https://docs.readwise.io/images/tts_change-voice.png)
Then tap `View all languages` at the bottom of the menu.

![View non-English languages for text-to-speech.](https://docs.readwise.io/images/tts_view-all-languages_mobile.png)
...
Bundles are collections of documents with pretty landing pages that can easily be shared with others. (As an example, check out [this bundle of every public beta update](https://readwise.io/reader/view/public-beta-updates) we've sent out for Reader.)

To create your own bundle, first [create a filtered view](https://blog.readwise.io/reader/docs/faqs/filtered-views) in the web app, then click the down chevron next to its name and select `Enable public link`. You can optionally add a cover image to spice up the public landing page.
...
![Refresh the content of a public bundle.](https://docs.readwise.io/images/bundle_refresh-public-link.png)
...
![Ghostreader toggle in Reader's account preferences on web.](https://docs.readwise.io/images/reader-ghostreader_disable-toggle-web.png)
On mobile, open the **Account** tab, scroll down to the **General** section, and toggle off **Enable Ghostreader**.

![Ghostreader toggle in the Account tab on mobile.](https://docs.readwise.io/images/reader-ghostreader_disable-toggle-mobile.png)
