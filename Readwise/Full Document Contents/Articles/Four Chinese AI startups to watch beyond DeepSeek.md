...
![rw-book-cover](https://wp.technologyreview.com/wp-content/uploads/2025/02/ai-china-4stepup.jpg?resize=1200,600)

## Metadata
- Author: [[Caiwei Chen]]
- Full Title: Four Chinese AI startups to watch beyond DeepSeek
- Category: #articles
- Summary: China's AI sector is rapidly growing, with startups like Stepfun, ModelBest, Zhipu, and Infinigence AI emerging as key players. These companies are innovating in areas such as foundational models, efficient processing, and AI infrastructure, despite facing challenges from US sanctions. As the competition intensifies, smaller firms must find unique niches to thrive in the evolving landscape.
- URL: https://www.technologyreview.com/2025/02/04/1110942/four-chinese-ai-startups-deepseek/

## Full Document
These companies are all in a position to compete both within China and beyond.

![""](https://wp.technologyreview.com/wp-content/uploads/2025/02/ai-china-4stepup.jpg?fit=2252,1266)
...
This company is now working with AI application developers, who are building on top of its models. According to [Chinese media outlet 36Kr](https://36kr.com/p/3090736042736004), demand from external developers to use Stepfun’s multimodal API surged over 45-fold in the second half of 2024.

##### **ModelBest**

Researchers at the prestigious Tsinghua University founded ModelBest in 2022 in Beijing’s Haidian district. Since then, the company has distinguished itself by leaning into efficiency and embracing the trend of [small language models](https://www.technologyreview.com/2025/01/03/1108800/small-language-models-ai-breakthrough-technologies-2025/). Its MiniCPM series—often dubbed “Little Powerhouses” in Chinese—is engineered for on-device, real-time processing on smartphones, PCs, automotive systems, smart home devices, and even robots. Its pitch to customers is that this combination of smaller models and local data processing cuts costs and enhances privacy.
...
Also originating at Tsinghua University, Zhipu AI has grown into a company with strong ties to government and academia. The firm is developing foundational models as well as AI products based on them, including ChatGLM, a conversational model, and a video generator called Ying, which is akin to OpenAI’s [Sora](https://www.technologyreview.com/2024/12/09/1108309/how-to-use-sora-openais-new-video-generating-tool/) system.

GLM-4-Plus, the company’s most advanced large language model to date, is trained on high-quality synthetic data, which reduces training costs, but has still matched the performance of GPT-4. The company has also developed GLM-4V-Plus, a vision model capable of interpreting web pages and videos, which represents a step toward AI with more [“agentic”](https://www.technologyreview.com/2025/01/11/1109909/anthropics-chief-scientist-on-5-ways-agents-will-be-even-better-in-2025/) capabilities.
