...
![rw-book-cover](https://www.gov.uk/assets/static/govuk-opengraph-image-dade2dad5775023b0568381c4c074b86318194edb36d3d68df721eea7deeac4b.png)

## Metadata
- Author: [[www.gov.uk]]
- Full Title: Content Design: Planning, Writing and Managing Content
- Category: #articles
- Summary: People read differently online, so write for what users need and make content quick to scan. Use plain, common words and short sentences so everyone — including specialists — can understand. Make clear, unique titles and summaries so users can tell at a glance if the page has the information they want.
...
Research from the Nielsen Norman Group shows [people read differently on the web](http://www.nngroup.com/articles/how-users-read-on-the-web/) than they do on paper. This means that the best approach when writing for the web is different from writing for print.
...
All of this guidance is based on the learning skills of an average person in the UK, who speaks English as their first language. This guidance also applies when you’re [writing for specialists](https://www.gov.uk/guidance/content-design/writing-for-gov-uk#writing-specialists).
...
Instead, [users only read about 20 to 28% of a web page](http://www.nngroup.com/articles/how-little-do-users-read/) according to research from the Nielsen Norman Group. Where users just want to complete their task as quickly as possible, they skim even more out of impatience.
...
Find out what the public calls your content [by using search tools to look up keywords](https://www.gov.uk/guidance/content-design/data-and-analytics#popular-keywords-seo). Your scheme, organisation or process’s official or internal name may not be what the public calls it.
...
For more examples of words not to use in summaries, read the [words to avoid list](https://www.gov.uk/guidance/style-guide/a-to-z-of-gov-uk-style#words-to-avoid).
...
You do not always need text between the heading and the start button. [View a good example of a start button directly under a heading](https://www.gov.uk/sqa-qualifications-approval-scotland).
...
Watch this [Why you should use the correct heading structure in your content video](https://youtu.be/-CuSHeInjPM) which shows how a screen reader interacts with headings. If you can’t see the video, you can read the full transcript in the description section.
...
If your call-centres get questions that really are frequently asked, [get in touch](https://support.publishing.service.gov.uk/) and GDS will help find a way to take care of those user needs.

Writing to GOV.UK style 

It’s important to stick to [the style guide](https://www.gov.uk/guidance/style-guide). The style guide is based on a lot of user testing.

GDS commissioned [research on the impact of style guides](https://www.gov.uk/government/publications/govuk-content-principles-conventions-and-research-background). Have a look.
...
[How to add links to content and GOV.UK’s linking policy](https://www.gov.uk/guidance/content-design/links)

Plain English is mandatory for all of GOV.UK. One of the parts most people pick up on is the [plain English (or words to avoid) list](https://www.gov.uk/guidance/style-guide/a-to-z-of-gov-uk-style#words-to-avoid).
...
[Words to use and avoid when writing about disability](https://www.gov.uk/government/publications/inclusive-communication).
...
Confirm regularly that your content works for your users. Use [Content Data](https://content-data.publishing.service.gov.uk/content) to check:
...
For example, if you sign up for [email alerts](https://www.gov.uk/help/update-email-notifications) on the [education taxonomy](https://www.gov.uk/education) topic you’ll be emailed when any of the related pages are updated.
