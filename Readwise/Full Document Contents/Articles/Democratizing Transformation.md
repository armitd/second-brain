...
![rw-book-cover](https://hbr.org/resources/images/article_assets/2022/04/S22031_MADRID_TOC.jpg)

## Metadata
- Author: [[Harvard Business Review]]
- Full Title: Democratizing Transformation
- Category: #articles
- Summary: The text discusses how companies like Novartis are democratizing access to data and technology to drive digital transformation across all functions.
To succeed in digital transformation, companies need to build capabilities in employees outside of traditional technology roles and foster a culture of experimentation and innovation.
Investing in technology and empowering a broad community of employees with digital skills leads to higher tech intensity and better performance.
- URL: https://hbr.org/2022/05/democratizing-transformation

## Full Document
![](https://hbr.org/resources/images/article_assets/2022/03/S22031_MADRID.jpg) Núria Madrid 

>  Summary. Many companies struggle to reap the benefits of investments in digital transformation, while others see enormous gains. What do successful firms do differently? This article describes the five stages of digital transformation, from the traditional stage, where digital and... 
...
[download PDF](https://hbr.org/download/subscriber/reprint/R2203B-PDF-ENG)  

[buy copies](https://store.hbr.org/product/the-digitally-literate-organization/r2203b?sku=R2203B-PDF-ENG)
...
To enable transformation, companies must create synergy in three key areas: Capabilities Organizational culture Training ...
...
![Digital Transformation Pays Off. We studied 150 companies in a range of industries and found that revenue growth and compound annual growth rate among the leaders (the top quartile) in tech intensity were more than double that of the laggards (the bottom quartile). The exhibit shows two bar charts. The first compares revenue growth from 20 16 through 20 19 for laggards (4.4%) and leaders (9.1%). The second compares CAGR over the same time period for laggards (7.1%) and leaders (14.9%). Source: Keystone.](https://hbr.org/resources/images/article_assets/2022/04/S22031_IANSITI_TRANSFORMATION_360.png)
[See more HBR charts in Data & Visuals](https://hbr.org/data-visuals) 

We ranked the tech intensity of the 150 firms in our study and found that the top quartile of the sample grew their revenues more than twice as fast as the bottom quartile. (See the exhibit “Digital Transformation Pays Off.” To score your firm’s tech intensity, go to [www.keystone.ai/techintensity](https://www.keystone.ai/tech-intensity/).) We also found that technology, capability, and architecture indices correlated with other measures of performance, from productivity and profits to growth in enterprise value. Using an econometric technique known as *instrumental variables,* we also found evidence that the relationship between tech intensity and performance was causal: That is, greater intensity (especially investments in technical and organizational architecture) powered higher revenue growth.
...
![The Stages of Digital Maturity. The five stages of digital maturity are made up of varying characteristics of organizational structure, process, tech architecture, and tech deployment. How does your company stack up? 
1. The least digitally mature or Traditional stage is characterized by Siloed business units; Localized applications and decision-making; Siloed data; and Business-unit-based machine-learning models.  
2. The Bridge stage includes characteristics such as Centralized data like a science team; Agile development teams; an Elastically scalable cloud-based data platform; and APIs for sharing data internally.  
3. At the Hub Stage characteristics include Real-time insights shared across business units; Business ownership of apps; a Unified modular data platform; and Advanced and automated machine-learning models.  
4. The characteristics of the Platform Stage are App-enabled mature capabilities and insights; Distributed innovation and citizen developers; an Integrated foundation of software, data, and AI with consistent architecture and integrated APIs; and Advanced AI-development abilities.  
5. Finally, the most digitally mature or Native Stage features Democratized data-driven innovation combined with very deep AI expertise; Agile culture with end-to-end solution ownership; Customized self-maintained tools and platform infrastructure; and Optimized and highly automated machine-learning technology.](https://hbr.org/resources/images/article_assets/2022/04/S22031_IANSITI_STAGES_610.png)
[See more HBR charts in Data & Visuals](https://hbr.org/data-visuals) 
...
![](https://hbr.org/resources/images/article_assets/2022/03/S22031_MADRID_A.jpg)
Núria Madrid
...
![Digital Maturity by Industry. We looked at 150 companies in a range of industries and plotted the average levels of technology capability and technology architecture for each industry. Companies in consumer packaged goods, for example, tended to be at the early stage of the transformation journey; aerospace and health care firms were much more advanced. This chart shows the maturity stage of each of 11 sectors. The consumer packaged goods sector lies in the traditional stage, where tech capability and tech architecture are both weaker. The next stage of maturity is the bridge stage, where pharmaceuticals, retail, industrial building electronics, and machines and equipment companies can be found. Next, the hub stage of maturity contains manufacturing conglomerates, and the medical devices, financial services, and technology hardware sectors. The most mature stage is the platform stage, where tech capability and tech architecture are both stronger; aerospace and health care companies are found in this stage. Source: Keystone.](https://hbr.org/resources/images/article_assets/2022/04/S22031_IANSITI_INDUSTRY_360.png)
[See more HBR charts in Data & Visuals](https://hbr.org/data-visuals) 
...
A version of this article appeared in the [May–June 2022](https://hbr.org/archive-toc/BR2203) issue of *Harvard Business Review*.
