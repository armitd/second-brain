...
- Category: #articles
- Summary: Reader is a new productivity software that allows users to read, highlight, and annotate documents using keyboard shortcuts. It supports various document types and includes a browser extension for easy saving and highlighting. Additionally, it features mobile apps with text-to-speech and YouTube video highlighting capabilities.
