...
![rw-book-cover](https://miro.medium.com/v2/resize:fit:1200/1*oETLwMpxy3oH_B9pN-xLcg.png)

## Metadata
- Author: [[Rohit Patel]]
- Full Title: Understanding LLMs from scratch using middle school math
- Category: #articles
- Summary: Neural networks process numbers as inputs and outputs, and they can classify these inputs into categories like letters or words. The model needs to be trained to understand how to transform input numbers into meaningful output numbers based on weights assigned to the network. Techniques like embeddings and softmax help the network predict the next character or word by interpreting the highest output value.
- URL: https://towardsdatascience.com/understanding-llms-from-scratch-using-middle-school-math-e602d27ec876

## Full Document
#### A self-contained guide to inner workings of an LLM
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ymWXxVf7N4-Ps-62Cih2XQ.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*D-e4rt_QBPp1fMY5OseJiQ.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*XPyJ-V0vbPv6EDwFpk7KYQ.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*0_tSCfEAL9NIK8U95Q-6Vg.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*lZOR8fNDEWHxUhLCSB-67A.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*VGNZ1Zighiek1sAMdiZCaw.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*oETLwMpxy3oH_B9pN-xLcg.png)Self attention. Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*OgcRxWyftIXN8WbQw_-QKg.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*jSyo_owKB-tfTrPXV2giKg.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*270MXDfslVtvmBjShHL2hQ.png)A residual connection. Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Zd-PvX2cYslEyrjL6MVnzA.png)Layer Normalization. Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*j0oKuXvH7kfrIpIfXE03VA.png)Image by author 
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*UodvtsDn5z73Cp578XOoVw.png)Image by author 
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*qHPSwQmV3sfvKT5pG4TEJw.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*BmZd8SIDEQu7r5_R7y54kQ.png)Multi-head attention. Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*U9mQKCWiyakNVwxU)The GPT Architecture. Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Mq4hBZcKPL9GALPSSQG9Xg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*psIz3-v2dMfI3SMsFQjRPQ.png)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1366/format:webp/1*uPwJ24na4D_ECHBv1Lg5Fg.png)Image from Vaswani et al. (2017) 
...
![](https://miro.medium.com/v2/resize:fit:1362/format:webp/0*sXvYIassJutgqw5W)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*woel5Da5Z22EmiGx)Image by author 
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*yn1TPuxw_QqnD93k)Image by author 
