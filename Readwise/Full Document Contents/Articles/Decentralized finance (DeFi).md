...
![rw-book-cover](https://ethereum.org/images/use-cases/defi.png)

## Metadata
- Author: [[ethereum.org]]
- Full Title: Decentralized finance (DeFi)
- Category: #articles
- Summary: DeFi is an open and global financial system built for the internet age – an alternative to a system that's opaque, tightly controlled, and held together by decades-old infrastructure and processes. It gives you control and visibility over your money.
- URL: https://ethereum.org/en/defi/

## Full Document
![](https://ethereum.org/_next/image/?url=%2Fimages%2Fuse-cases%2Fdefi.png&w=1920&q=75)
...
![](https://i.ytimg.com/vi/H-O3r2YMWJ4/hqdefault.jpg)
...
[Explore DeFi apps](https://ethereum.org/en/dapps/?category=finance#explore)
...
![](https://i.ytimg.com/vi/qFBYB4W2tqU/hqdefault.jpg)
#### Programmable money
...
* [Access stable currencies](https://ethereum.org/en/defi/#stablecoins)
* [Borrow funds with collateral](https://ethereum.org/en/defi/#lending)
* [Borrow without collateral](https://ethereum.org/en/defi/#flash-loans)
* [Start crypto savings](https://ethereum.org/en/defi/#saving)
* [Trade tokens](https://ethereum.org/en/defi/#swaps)
* [Grow your portfolio](https://ethereum.org/en/defi/#investing)
* [Fund your ideas](https://ethereum.org/en/defi/#crowdfunding)
* [Buy insurance](https://ethereum.org/en/defi/#insurance)
* [Manage your portfolio](https://ethereum.org/en/defi/#aggregators)

##### Send money around the globe quickly

As a blockchain, Ethereum is designed for sending transactions in a secure and global way. Like Bitcoin, Ethereum makes sending money around the world as easy as sending an email. Just enter your recipient's (like bob.eth) or their account address from your wallet and your payment will go directly to them in minutes (usually). To send or receive payments, you will need a [wallet](https://ethereum.org/en/wallets/).

[See payment dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
And if you don't want to send or stream because of how much its value can change, there are alternative currencies on Ethereum: .
...
[More on stablecoins](https://ethereum.org/en/stablecoins/)
...
[See borrowing dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
Decentralized lending works without either party having to identify themselves. Instead, the borrower must put up collateral that the lender will automatically receive if their loan is not repaid. Some lenders even accept as collateral. NFTs are a deed to a unique asset, like a painting. [More on NFTs](https://ethereum.org/en/nft/)
...
[More on flash loans(opens in a new tab)](https://aave.com/flash-loans/)
...
* You lend your 100 Dai, a [stablecoin](https://ethereum.org/en/stablecoins/), to a product like Aave.
* You receive 100 Aave Dai (aDai) which is a token that represents your loaned Dai.
* Your aDai will increase based on the interest rates and you can see your balance growing in your wallet. Dependent on the , your wallet balance will read something like 100.1234 after a few days or even hours!
* You can withdraw an amount of regular Dai that's equal to your aDai balance at any time.

[See lending dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
[Try PoolTogether(opens in a new tab)](https://pooltogether.com)
...
[See token exchanges](https://ethereum.org/en/dapps/?category=finance#explore)
...
[See trading dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
A good example is the [DeFi Pulse Index fund (DPI)(opens in a new tab)](https://defipulse.com/blog/defi-pulse-index/). This is a fund that rebalances automatically to ensure your portfolio always includes the top DeFi tokens by market capitalization. You never have to manage any of the details and you can withdraw from the fund whenever you like.

[See investment dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
[See crowdfunding dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
[More on quadratic funding(opens in a new tab)](https://wtfisqf.com)
...
Ethereum products, like any software, can suffer from bugs and exploits. So right now a lot of insurance products in the space focus on protecting their users against loss of funds. However, there are projects starting to build out coverage for everything life can throw at us. A good example of this is Etherisc's Crop cover which aims to [protect smallholder farmers in Kenya against droughts and flooding(opens in a new tab)](https://blog.etherisc.com/etherisc-teams-up-with-chainlink-to-deliver-crop-insurance-in-kenya-137e433c29dc). Decentralized insurance can provide cheaper cover for farmers who are often priced out of traditional insurance.

[See insurance dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
[See portfolio dapps](https://ethereum.org/en/dapps/?category=finance#explore)
...
2. The assets – [ETH](https://ethereum.org/en/eth/) and the other tokens (currencies).
3. The protocols – that provide the functionality, for example, a service that allows for decentralized lending of assets.
4. [The applications](https://ethereum.org/en/dapps/) – the products we use to manage and access the protocols.

Note: much of DeFi uses the . Applications in DeFi use a wrapper for ETH called Wrapped Ether (WETH). [Learn more about wrapped ether](https://ethereum.org/en/wrapped-eth/).
...
[More on building dapps](https://ethereum.org/en/developers/docs/dapps/)

#### Further reading

##### DeFi data

* [DeFi Prime(opens in a new tab)](https://defiprime.com/)
* [DeFi Llama(opens in a new tab)](https://defillama.com/)

##### DeFi articles

* [A beginner's guide to DeFi(opens in a new tab)](https://blog.coinbase.com/a-beginners-guide-to-decentralized-finance-defi-574c68ff43c4) – *Sid Coelho-Prabhu, January 6, 2020*

##### Videos

* [Finematics - decentralized finance education(opens in a new tab)](https://finematics.com/) – *Videos on DeFi*
* [The Defiant(opens in a new tab)](https://www.youtube.com/playlist?list=PLaDcID4s1KronHMKojfjwiHL0DdQEPDcq) - *DeFi basics: Everything you need to know to get started in this occasionally baffling space.*
* [Whiteboard Crypto(opens in a new tab)](https://youtu.be/17QRFlml4pA) *What is DeFi?*

##### Communities

* [DeFi Llama Discord server(opens in a new tab)](https://discord.defillama.com/)
* [DeFi Pulse Discord server(opens in a new tab)](https://discord.gg/Gx4TCTk)
