...
## Metadata
- Author: [[Todoist]]
- Full Title: Getting Things Done (GTD)
- Category: #articles
- Summary: Getting Things Done (GTD) is a task management system created by David Allen that helps you organize tasks efficiently. It involves capturing tasks immediately, categorizing them as projects or actions, and regularly reviewing your progress. You can use tools like Todoist to manage tasks, set due dates, and collaborate with others.
