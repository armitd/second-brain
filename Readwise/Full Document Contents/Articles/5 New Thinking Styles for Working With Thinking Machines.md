...
![rw-book-cover](https://d24ovhgu8s7341.cloudfront.net/uploads/post/social_media_image/3467/Cover_Image_Frame.png)

## Metadata
- Author: [[Dan Shipper]]
- Full Title: 5 New Thinking Styles for Working With Thinking Machines
- Category: #articles
- Summary: Dan Shipper discusses how the rise of AI is changing the way we think and solve problems. In a post-AI world, we focus more on understanding sequences and patterns rather than strict rules and processes. This shift will emphasize predictions over explanations, transforming challenges into engineering opportunities.
...
## Full Document
![](https://d24ovhgu8s7341.cloudfront.net/uploads/post/cover/3467/Cover_Image_Frame.png)DALL-E/Every illustration.
AI is turning science into engineering—with unprecedented changes for how we see the world

*It’s the last day of* [*Every’s*](https://every.to/on-every/welcome-to-q2-2024) [*think*](https://every.to/context-window/we-do-be-thinking) [*week*](https://every.to/context-window/thinking-up-the-future)*—our quarterly time to dream up new ideas and products that can help us improve how we do our work and, more importantly, your experience as a member of our community. In lieu of publishing new stories, we’ve* [*been*](https://every.to/chain-of-thought/how-language-models-work-ea805869-4778-4fb8-ad8f-2d10cc439b4c) [*re-upping*](https://every.to/chain-of-thought/what-can-language-models-actually-do-371b969e-d470-4639-a9fa-f873c133c19b) [*pieces*](https://every.to/chain-of-thought/llms-turn-every-question-into-an-answer-e44c1bb4-b8d5-42a1-9335-38c0bfd2c856) *by* ***Dan Shipper*** *(who’s been on hiatus from writing his regular* [***Chain of Thought***](https://every.to/chain-of-thought) *column to work on a longer piece) that cover basic, powerful questions about AI. Last up is* [*his piece*](https://every.to/chain-of-thought/five-new-thinking-styles-for-working-with-thinking-machines) *about how humans should think in a world with thinking machines. We'll be back with a new piece on Monday.*—[*Kate Lee*](https://every.to/on-every/kate-lee-joins-every-as-editor-in-chief)

*Was this newsletter forwarded to you?* [*Sign up*](https://every.to/account) *to get it in your inbox.*

A world with thinking machines requires new thinking styles. Our default thinking style in the West is [scientific](https://every.to/c/ai-frontiers) and rationalist. When was the last time you heard someone talking about a hypothesis or theory in a meeting? When was the last time, when sitting down to solve a problem, you reminded yourself to think from first principles? When was the last time you tried an experiment in your work or personal life?

Even the frameworks we use to understand business are scientific: It’s unlikely that Harvard Business School professor **Michael Porter** would have looked for or found [five “forces”](https://en.wikipedia.org/wiki/Porter%27s_five_forces_analysis) governing business without physics as inspiration; **Clay Christensen**’s [jobs-to-be-done framework](https://jobs-to-be-done.com/jobs-to-be-done-a-framework-for-customer-needs-c883cbf61c90) is close to an [atomic theory](https://en.wikipedia.org/wiki/History_of_atomic_theory) of startup ideas.
...
But new technologies demand new thinking styles. As the AI age unfolds, we are shifting away from what former Tesla and OpenAI engineer [**Andrej Karpathy** calls Software 1.0](https://karpathy.medium.com/software-2-0-a64152b37c35)—software that consists of instructions written by humans, and which benefits from a scientific, rationalist thinking style.

Instead, we're moving into Software 2.0 (a shift that **Michael Taylor** [recently wrote about](https://every.to/also-true-for-humans/the-key-to-great-ai-prompting-show-don-t-tell)), where we describe a goal that we want to achieve and train a model to accomplish it. Rather than having a human write instructions for the computer to follow, training works by searching through a space of possible programs until we find one that works. In Software 2.0, problems of science—which is about formal theories and rules—become problems of engineering, which is about accomplishing an outcome.
...
In a post-AI world, we are less concerned with essence and more concerned with sequence: the underlying chain of events that leads to a certain thing to happen. Language models do this when they predict [what word comes next in a string of characters](https://every.to/about); self-driving cars also do this when they predict where to drive next from a sequence of video, depth, and GPS data.
...
If the raw material for creative work becomes sequences and intuition instead of rules, essences, and processes, how you do your work is going to look significantly different. It will look more like [gardening as opposed to sculpting](https://every.to/chain-of-thought/when-ai-gets-more-capable-what-will-humans-do).
...
But explanations are notoriously hard to come by. The reason smart business people don’t read books like [*Think Like Zuck: The Five Business Secrets of Facebook's Improbably Brilliant CEO Mark Zuckerberg*](https://www.amazon.com/Think-Like-Zuck-Improbably-Zuckerberg/dp/007180949X/ref=sr_1_fkmr1_1?crid=2UEHXFGA16EB7&dib=eyJ2IjoiMSJ9.5PKNgS1AcNPFYyGsmng1Goao2zKsohOAbHfYEx7a2dQR_DV1VNYF4ykJcXuKbz8QyRX14_dZeErnON4UuaWC2VgaoIpZHBLPqVwnJzIGWP8.2VHAXe965rzNr8cYjXTBhsLylvOXaw_viez_TAmepBg&dib_tag=se&keywords=mark+zuckerberg%27s+framework&qid=1728588875&sprefix=mark+zuckerberg%27s+framework%2Caps%2C115&sr=8-1-fkmr1)—a real book, by the way—is because we know it’s unlikely to contain the actual explanations for **Mark Zuckerberg**’s success. Zuckerberg might be able to explain some of it, but even he would probably say that he has developed an underlying intuition that guides his decision-making that is not fully explainable.

In a post-AI world, we will prioritize [predictions over explanations](https://every.to/chain-of-thought/against-explanations), especially in complex domains. Zuckerberg’s intelligence might not be reducible to rules, but it can be encapsulated in a model if it is given the right sequences to train its intuition. This is starting to happen in science, too. The 2024 Nobel Prize winners in both [physics](https://x.com/nobelprize/status/1843589140455272810?s=46) and [chemistry](https://x.com/nobelprize/status/1843951594909380878?s=46) were computer scientists who built architectures for better predictions, not physicists who had come up with better explanations.
