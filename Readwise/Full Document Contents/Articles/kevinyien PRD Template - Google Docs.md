# kevinyien: PRD Template - Google Docs

![rw-book-cover](https://www.google.com/favicon.ico)

## Metadata
- Author: [[google.com]]
- Full Title: kevinyien: PRD Template - Google Docs
- Category: #articles
- Summary: Problem Alignment is a document template that helps teams define and align on the problem they are trying to solve in a project. It includes sections for describing the problem, the high-level approach to tackling it, narratives to paint a picture of the customer's experience, goals, non-goals, key features, key flows, key logic, launch plan, key milestones, operational checklist, appendix, changelog, open questions, FAQs, and impact checklist. The document aims to ensure that all contributors are aligned on the problem and that there is a clear plan for addressing it.
- URL: https://docs.google.com/document/d/1mEMDcHmtQ6twzNlpvF-9maNlAcezpWDtCnyIqWkODZs/mobilebasic
...
|  |
| --- |
| Describe the problem we are trying to solve in 1-2 sentences. I should be able to read this alone and communicate the value/risks to someone else.* Why does this matter to our customers and business?
