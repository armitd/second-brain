...
## Metadata
- Author: [[maggierui]]
- Full Title: Plan an intelligent SharePoint intranet
- Category: #articles
- Summary: To plan an effective SharePoint intranet, first understand your organization's goals and audience. Next, review your existing intranet and prioritize initiatives that align with your business needs. Finally, create a prototype, engage stakeholders, and promote user adoption to ensure success.
- URL: https://learn.microsoft.com/en-us/sharepoint/plan-intranet

## Full Document
#### In this article

1. [What's possible with SharePoint?](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#whats-possible-with-sharepoint)
2. [Understand current business goals and key stakeholders](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#understand-current-business-goals-and-key-stakeholders)
3. [Understand your audience](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#understand-your-audience)
4. [Think about governance](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#think-about-governance)
5. [Review your existing intranet](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#review-your-existing-intranet)
6. [Identify initiatives](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#identify-initiatives)
7. [Choose pilot scenarios](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#choose-pilot-scenarios)
8. [Choose solution components](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#choose-solution-components)
9. [Roll out the pilot](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#roll-out-the-pilot)
10. [Related articles](https://learn.microsoft.com/en-us/sharepoint/plan-intranet#related-articles)
...
For an understanding about how the different component parts work together, review the [Guide to the Modern experience in SharePoint](https://learn.microsoft.com/en-us/sharepoint/guide-to-sharepoint-modern-experience).
...
* Who can provision new sites and when they're provisioned, what is the process to ensure that sites are discovered in navigation or as key [bookmarks](https://learn.microsoft.com/en-us/microsoftsearch/make-content-easy-to-find#bookmarks) in search?
...
* Does intranet content need to be [retained](https://learn.microsoft.com/en-us/microsoft-365/compliance/retention-policies) based on your retention policies or [classified](https://learn.microsoft.com/en-us/microsoft-365/compliance/sensitivity-labels) based on its sensitivity?
...
![Chart showing relationship between impact and ease of implementation for example intranet sites](https://learn.microsoft.com/en-us/sharepoint/sharepointonline/media/intranet-impact-ease-grid.png)
...
| --- | --- | --- | --- | --- |
| Educate employees about benefits (Benefits site) | - Announcements  - Training videos | HR | - News post views  - Training video views | Help requests are reduced by x% |
| Weekly news post by a senior leader | - Streaming events  - Formal training | Engineering | - Training content produced for all aspects of coding excellence  - Monthly streaming events | Training completed successfully by x% of engineering staff |
| Foster positive employee agreement about company strategy (Executive Leadership Viva Engage Community) | News posts  - Streaming events  - Viva Engage conversations | HR | Ongoing monthly activity posts by leadership and comments by employees | - Viva Engage conversations show positive sentiment  - Comments addressed within 24 hours – "no question/comment left behind"  - x% increase in employee satisfaction scores for executive communications |
| Improve timeliness consistency in proposal development (Marketing site) | - Company business value slides  - Proposal templates | Marketing | - Slide downloads  - Sales team alignment | x% reduction in the time to create proposals |
...
| User journey | - News post is sent to the company announcing a leadership Q&A meeting  - Allan goes to the leadership portal to watch the event live  - Allan uses Viva Engage to ask a question at the meeting  - Allan shares the recording link with coworkers. |
| Metrics | - Live event views  - Event recording views  - Viva Engage engagement |
| Stretch goals | - Continued Viva Engage engagement  - Improving employee sentiment (survey) |
...
* **[Home site](https://learn.microsoft.com/en-us/sharepoint/home-site)** - A home site is a communication site that you set as the intranet landing page for your organization.
* **[Hub sites](https://learn.microsoft.com/en-us/sharepoint/planning-hub-sites)** - Use hub sites to organize related sites and teams and centralize news, search, and content management.
...
* **[Viva Engage](https://learn.microsoft.com/en-us/viva/engage/overview)** - Use Viva Engage to connect with people across your organization beyond the boundaries of projects, functions, and departments.
* **[Dynamics 365 Customer Voice](https://learn.microsoft.com/en-us/dynamics365/customer-voice/help-hub)** - Use Dynamics 365 Customer Voice to create custom quizzes, surveys, questionnaires, registrations, and more.
* **[Stream](https://learn.microsoft.com/en-us/stream)** - Use Stream to deliver live and on-demand meetings, events, and training.
...
For best practices for launching an intranet site, review [Creating and launching a healthy SharePoint portal](https://learn.microsoft.com/en-us/sharepoint/portal-health).
