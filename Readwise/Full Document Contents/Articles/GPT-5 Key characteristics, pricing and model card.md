...
![rw-book-cover](https://static.simonwillison.net/static/2025/gpt-5-pelican-card.jpg)

## Metadata
- Author: [[Simon Willison]]
- Full Title: GPT-5: Key characteristics, pricing and model card
- Category: #articles
- Summary: GPT-5 is a new model family with smart routing between versions for different tasks and levels of reasoning. It improves safety, reduces errors, and is competitively priced compared to earlier OpenAI models. The API supports detailed reasoning traces, and GPT-5 replaces most older models except those for audio and image tasks.
