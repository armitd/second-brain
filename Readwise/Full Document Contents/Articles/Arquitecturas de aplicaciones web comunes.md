...
![rw-book-cover](https://learn.microsoft.com/dotnet/media/dotnet-bot_microservices.png)

## Metadata
- Author: [[ardalis]]
- Full Title: Arquitecturas de aplicaciones web comunes
- Category: #articles
- Summary: Este contenido es un extracto del libro electrónico "Architect Modern Web Applications with ASP.NET Core and Azure" (Diseño de la arquitectura de aplicaciones web modernas con ASP.NET Core y Azure), disponible en Documentación de .
- URL: https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures

## Full Document
#### En este artículo

1. [¿Qué es una aplicación monolítica?](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures#what-is-a-monolithic-application)
2. [Aplicaciones todo en uno](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures#all-in-one-applications)
3. [¿Qué son las capas?](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures#what-are-layers)
4. [Aplicaciones tradicionales de arquitectura de "N capas"](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures#traditional-n-layer-architecture-applications)
5. [Arquitectura limpia](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures#clean-architecture)
6. [Aplicaciones monolíticas y contenedores](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures#monolithic-applications-and-containers)
7. [Compatibilidad con Docker](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures#docker-support)

Sugerencia

Este contenido es un extracto del libro electrónico "Architect Modern Web Applications with ASP.NET Core and Azure" (Diseño de la arquitectura de aplicaciones web modernas con ASP.NET Core y Azure), disponible en [Documentación de .NET](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure) o como un PDF descargable y gratuito para leerlo sin conexión.

[Descargar PDF](https://dotnet.microsoft.com/en-us/download/e-book/aspnet/pdf)

![Architect Modern Web Applications with ASP.NET Core and Azure eBook cover thumbnail.](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/cover-thumbnail.png)
...
![A single project ASP.NET Core app](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-1.png)
...
![Typical application layers](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-2.png)
...
![A simple monolithic application with three projects](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-3.png)
...
![Simple deployment of Azure Web App](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-4.png)
...
![Deploying a web app to an Azure App Service](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-5.png)
...
![Clean Architecture; onion view](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-7.png)
...
![Clean Architecture; horizontal layer view](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-8.png)
...
![ASP.NET Core architecture diagram following Clean Architecture](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-9.png)
...
![UnitTestCore](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-10.png)
**Figura 5-10.** Pruebas unitarias del núcleo de la aplicación de forma aislada.

![IntegrationTests](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-11.png)
...
![ASP.NET Core Architecture 2](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-12.png)
...
![Figure 5-13](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/media/image5-13.png)
...
* [Web-Cola-Trabajo](https://learn.microsoft.com/es-es/azure/architecture/guide/architecture-styles/web-queue-worker): los componentes principales de esta arquitectura son un front-end web que atiende solicitudes de cliente y un trabajo que realiza tareas que consumen muchos recursos, flujos de trabajo de ejecución prolongada o trabajos por lotes. El front-end web se comunica con el trabajo a través de una cola de mensajes.
* [Niveles](https://learn.microsoft.com/es-es/azure/architecture/guide/architecture-styles/n-tier): una arquitectura de niveles divide una aplicación en capas lógicas y niveles físicos.
* [Microservicio](https://learn.microsoft.com/es-es/azure/architecture/guide/architecture-styles/microservices): una arquitectura de microservicios consta de una colección de servicios autónomos y pequeños. Cada uno de servicio es independiente y debe implementar una funcionalidad de negocio individual dentro de un contexto delimitado.
...
* **DDD (diseño guiado por el dominio)**  
 [https://learn.microsoft.com/dotnet/architecture/microservices/microservice-ddd-cqrs-patterns/](https://learn.microsoft.com/es-es/dotnet/architecture/microservices/microservice-ddd-cqrs-patterns/)

[Anterior](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/architectural-principles)[Siguiente](https://learn.microsoft.com/es-es/dotnet/architecture/modern-web-apps-azure/common-client-side-web-technologies)
