...
![rw-book-cover](https://ccforeveryone.com/images/og-vin-obsidian.png)

## Metadata
- Author: [[ccforeveryone.com]]
- Full Title: Claude Code for Everyone
- Category: #articles
- Summary: Claude Code works best with good context, but sessions usually start from zero. Obsidian stores notes as linked markdown files, creating a map of your ideas that Claude Code can read. Using commands like /my-world and thinking tools helps Claude become a personalized assistant without changing your original notes.
...
![The Obsidian + Claude Code System — overview of vault infrastructure, custom commands, thinking tools, the golden rule, and the feedback flywheel](https://ccforeveryone.com/images/og-vin-obsidian.png)The Obsidian + Claude Code System — overview of vault infrastructure, custom commands, thinking tools, the golden rule, and the feedback flywheel

1. **Open terminal in that folder**
2. **Run `claude` then type `/start-lesson`**

>  **New to the terminal?** See [Getting Started: Installation](https://ccforeveryone.com/getting-started/installation) for setup help.
> 
>  
