...
![rw-book-cover](https://venturebeat.com/wp-content/uploads/2022/06/GettyImages-1394403496-BlackSalmon-e1663891228217.jpg?w=1200&strip=all)

## Metadata
- Author: [[Daniel Saito]]
- Full Title: Creating the internet we deserve: The case for Web3
- Category: #articles
- Summary: Join our daily and weekly newsletters for the latest updates and exclusive content on industry-leading AI coverage. Learn More There is no doubt that the internet has transformed the way we live and work. It has made communication and collaboration easier than ever before.
- URL: https://venturebeat.com/virtual/creating-the-internet-we-deserve-the-case-for-web3/

## Full Document
![Business person Steps into Future.](https://venturebeat.com/wp-content/uploads/2022/06/GettyImages-1394403496-BlackSalmon-e1663891228217.jpg?fit=750%2C378&strip=all)
...
The centralized nature of the internet means that a few large companies control most of what we see and do online. This concentration of power has led to concerns about [data privacy](https://venturebeat.com/datadecisionmakers/how-the-privacy-and-data-storage-features-of-web3-can-empower-societies/), censorship, and other abuses of power.
...
The 1990s were also the decade when the [World Wide Web Consortium](https://www.w3.org/) (W3C) was founded. The W3C is an organization that sets standards for how the web should work. Its best-known standards include HTML, CSS, and XML.
...
The gatekeepers can censor content, restrict access to information, and collect data about users without their consent. Several instances of abuse have been documented in recent years. In 2018, for example, Facebook was [embroiled in a scandal](https://www.nytimes.com/2018/04/04/us/politics/cambridge-analytica-scandal-fallout.html) over the misuse of user data.
...
Evidence for this can be traced back to the early days of the internet. The first iteration of the internet was known as ARPANET, and it was created by an arm of the U.S. Defense Department in the 1960s. ARPANET was [designed to be a decentralized network](https://repository.upenn.edu/dissertations/AAI9503730/) that could continue to function even if parts of it were destroyed.

The next phase of the internet’s development was the creation of the [TCP/IP protocol](https://blockchain.works-hub.com/learn/Drawing-Parralels-between-TCP-IP-and-the-Blockchain) in the 1970s. This protocol allows computers to communicate with each other on the internet. It too was designed to be decentralized, so that if one part of the network went down, the rest could still function.
...
Bitcoin is a [decentralized network](https://venturebeat.com/datadecisionmakers/the-basics-of-decentralized-finance/) that uses cryptography to secure its transactions. It is also the first and most well-known cryptocurrency. Since its launch, Bitcoin has been used for a variety of purposes, both legal and illegal. It has also been praised and criticized by people all over the world.
...
The [rise of cryptocurrencies](https://venturebeat.com/datadecisionmakers/explosive-defi-where-we-are-and-where-were-heading/) has led to the development of a new type of internet, known as Web3. Web3 is a decentralized network that is not controlled by any central authority.
...
Web3 can help to create a more sustainable internet by making it possible to run data centers on renewable energy sources — or [abandon the idea of data centers](https://impakter.com/the-environmental-case-for-edge-computing/) altogether by providing a better infrastructure for edge computing. The closer your information is to you, the better it is for the environment.
