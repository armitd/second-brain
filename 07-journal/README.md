...
- **Day One import** — export from Day One as **JSON** into `00-inbox/raw/dayone-import/`, then ask COG to "process my Day One export". Entries land here date-stamped by their **original entry date**, marked with `source: "dayone"` and a `#dayone` tag; photos go to `07-journal/attachments/` and are embedded. See [[00-inbox/raw/dayone-import/README]].
