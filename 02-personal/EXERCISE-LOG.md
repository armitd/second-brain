...
tags: ["#fitness", "#exercise", "#personal", "#health"]
---
...
*Current fitness goals — what I'm working toward and why.*

- *(none set yet — add a goal or two: e.g. run consistently 3x/week, improve recovery, a target event)*

---

## Weekly Log

*Most recent week at the top. Pull the few numbers that matter from Strava/Apple Health, then a line on how it actually felt.*

<!-- Weekly entry template — copy this block:
...
*(no entries yet — add the first weekly summary to test whether this layer earns its place)*

---

## Unrecorded Sessions

*Quick capture for exercise no app tracked (a walk, a kickabout, a gym session you forgot to start). Fold into the weekly summary later, or leave here.*
...
*Numbers live in Apple Health; meaning lives here. This is capture-and-reflect, not a task list — no `#planner` tags, never syncs to To Do.*
